    ...
    if (NOT EXISTS "${CMAKE_SOURCE_DIR}/lscript.ld")
        ...
        if(("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "cortexr5"))
            if("${CMAKE_MACHINE}" STREQUAL "Versal")
                ...
                list(APPEND LINKER_FILE_PATH ${path}/cortexr5_versal.ld)
                list(APPEND R5_LINKER_FILE cortexr5_versal.ld)
            else()
                ...
                list(APPEND LINKER_FILE_PATH ${path}/cortexr5.ld)
                list(APPEND R5_LINKER_FILE cortexr5.ld)
            endif()
        endif()
        ...
        if (${NON_YOCTO})
            if(("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "cortexr5"))
                execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${path}/${R5_LINKER_FILE} ${CMAKE_SOURCE_DIR}/)
            endif()
