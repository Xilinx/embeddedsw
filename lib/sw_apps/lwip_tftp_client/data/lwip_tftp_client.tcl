...
proc swapp_get_name {} {
    return "lwIP tftp client";
}

proc swapp_get_description {} {
    return "The lwIP tftp client application provides a simple demonstration of how to use the light-weight IP stack (lwIP) to implement a tftp client. This application sets up the board to use IP address 192.168.1.10 (in absence of DHCP server), with MAC address 00:0a:35:00:01:02."
}
