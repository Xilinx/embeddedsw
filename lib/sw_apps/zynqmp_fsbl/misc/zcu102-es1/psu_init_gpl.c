...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR0                         0x7
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01010702U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PCAP_CTRL_DIVISOR0                              0x7
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00A4, 0x01003F07U ,0x01000702U)
    */
	PSU_Mask_Write(CRL_APB_PCAP_CTRL_OFFSET, 0x01003F07U, 0x01000702U);
/*##################################################################### */
...
unsigned long psu_peripherals_init_data(void)
{
    ...
    * (OFFSET, MASK, VALUE)      (0XFD1A0100, 0x000E807EU ,0x00000000U)
    */
	PSU_Mask_Write(CRF_APB_RST_FPD_TOP_OFFSET, 0x000E807EU, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * pre lock comma count threshold. 2'b 00 : 3, 2'b 01 : 5, 2'b 10 : 10, 2'b
    *  11 : 20
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFE20C11C, 0x00000200U ,0x00000200U)
    */
	PSU_Mask_Write(USB3_0_XHCI_GUCTL1_OFFSET, 0x00000200U, 0x00000200U);
/*##################################################################### */
