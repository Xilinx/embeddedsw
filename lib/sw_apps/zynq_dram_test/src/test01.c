...
int verbose            =
	1;          // 1=memtest, 2=writeeye, 4='after', 8=print errors, 0x10=qual, 0x20 eye info, 0x40-lppdr2/drive test
...
int my_set_pll(int pll, int fbdiv, int outdiv, double fref)
{
	...
	switch (pll) {
		case 0:
			pll_ctrl = SLCR_LOW_BASE + ARM_PLL_CTRL;
			pll_cfg  = SLCR_LOW_BASE + ARM_PLL_CFG;
			break;

		case 1:
			pll_ctrl = SLCR_LOW_BASE + DDR_PLL_CTRL;
			pll_cfg  = SLCR_LOW_BASE + DDR_PLL_CFG;
			break;

		default:
			pll_ctrl = SLCR_LOW_BASE + IO_PLL_CTRL;
