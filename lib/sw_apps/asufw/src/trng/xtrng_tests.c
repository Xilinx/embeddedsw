...
s32 XTrng_DrbgKat(XTrng *InstancePtr)
{
	...
	u8 ExtSeed[XTRNG_KAT_SEED_LEN_IN_BYTES] = {
	...
	u8 ReseedEntropy[XTRNG_KAT_SEED_LEN_IN_BYTES] = {
	...
	u8 PersString[XTRNG_PERS_STRING_LEN_IN_BYTES] = {
	...
	u8 ExpectedOutput[XTRNG_SEC_STRENGTH_IN_BYTES] = {
