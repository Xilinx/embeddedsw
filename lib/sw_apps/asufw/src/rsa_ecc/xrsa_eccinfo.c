...
static const u8 XRsa_EccP25519D0[] = {
	0xFF, 0xFF, 0xFF, 0xFF, 0x18, 0x37, 0xE7, 0xB5,
	0xF4, 0x3A, 0xD5, 0x97, 0xF7, 0xD0, 0x02, 0x97,
	0x03, 0x91, 0x7E, 0x01, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB0,
	0xE1, 0x47, 0x25, 0x01,
};

static const u8 XRsa_EccP25519D1[] = {
...
static const u8 XRsa_EccP25519D2[] = {
	0xB7U, 0x43U, 0xB7U, 0x03U, 0x6DU, 0x6FU, 0x52U, 0x9BU,
	0x00U, 0xEAU, 0x47U, 0xDFU, 0xFEU, 0x8BU, 0xEDU, 0x80U,
	0x73U, 0x29U, 0xC6U, 0xAFU, 0x77U, 0x87U, 0xA1U, 0x10U,
	0x90U, 0x86U, 0x18U, 0xBCU, 0x07U, 0x92U, 0x93U, 0x65U,
};

static const u8 XRsa_EccP25519D3[] = {
	0xF0U, 0x1AU, 0x8EU, 0xE1U, 0xC1U, 0xE3U, 0xB9U, 0x6FU,
	0x15U, 0xDBU, 0x2BU, 0xFEU, 0xD4U, 0x07U, 0x58U, 0x3BU,
	0xEDU, 0xE9U, 0x1BU, 0xB5U, 0xFDU, 0x90U, 0xF5U, 0x03U,
	0xD1U, 0x02U, 0x62U, 0x33U, 0xBFU, 0x16U, 0x6EU, 0x6DU,
};

static const u8 XRsa_EccP25519D4[] = {
...
static const u8 XRsa_EccP25519D5[] = {
...
static const u8 XRsa_EccP25519D6[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFCU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x7FU,
	0x0DU, 0xE5U, 0x35U, 0x14U,
};

static const u8 XRsa_EccP25519D7[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP25519D8[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0xA4U, 0x05U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP25519D9[] = {
	0xEDU, 0xD3U, 0xF5U, 0x5CU, 0x1AU, 0x63U, 0x12U, 0x58U,
	0x06U, 0x5EU, 0x9AU, 0xD3U, 0x38U, 0xC8U, 0xB8U, 0x93U,
	0x9AU, 0x32U, 0x86U, 0xD0U, 0x15U, 0x62U, 0x10U, 0xB2U,
	0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x0FU,
};

static const u8 XRsa_EccP25519D10[] = {
	0xD4U, 0xE8U, 0x01U, 0xD3U, 0xEFU, 0xE8U, 0x72U, 0xE3U,
	0xCDU, 0xBEU, 0xCAU, 0x36U, 0x5FU, 0xDBU, 0x24U, 0xADU,
	0x71U, 0x5FU, 0x6EU, 0x5AU, 0x3EU, 0x57U, 0xEEU, 0xF2U,
	0xB4U, 0x31U, 0xA3U, 0x97U, 0xAAU, 0x63U, 0x5CU, 0x0BU,
};

static const u8 XRsa_EccP25519D11[] = {
	0x01U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP25519D12[] = {
	0xEDU, 0xD3U, 0xF5U, 0x5CU, 0x1AU, 0x63U, 0x12U, 0x58U,
...
static const u8 XRsa_EccP25519D13[] = {
	9,  3,  1,	1,	// 256
};

static const u8 XRsa_EccP25519D14[] = {
	0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccCurve25519D0[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x18U, 0x37U, 0xE7U, 0xB5U,
	0xF4U, 0x3AU, 0xD5U, 0x97U, 0xF7U, 0xD0U, 0x02U, 0x97U,
	0x03U, 0x91U, 0x7EU, 0x01U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0xB0U,
	0xE1U, 0x47U, 0x25U, 0x01U,
};
static const u8 XRsa_EccCurve25519D1[] = {
	0xEDU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x7FU,
};
static const u8 XRsa_EccCurve25519D2[] = {
	0x41U, 0xDBU, 0x01U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};
#define XRsa_EccCurve25519D3 XRsa_EccCurve25519D10
static const u8 XRsa_EccCurve25519D4[] = {
	0x09U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};
#define XRsa_EccCurve25519D5 0
static const u8 XRsa_EccCurve25519D6[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFCU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x7FU,
...
static const u8 XRsa_EccCurve25519D7[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x26U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};
static const u8 XRsa_EccCurve25519D8[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0xA4U, 0x05U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};
static const u8 XRsa_EccCurve25519D9[] = {
	0xEDU, 0xD3U, 0xF5U, 0x5CU, 0x1AU, 0x63U, 0x12U, 0x58U,
	0x06U, 0x5EU, 0x9AU, 0xD3U, 0x38U, 0xC8U, 0xB8U, 0x93U,
	0x9AU, 0x32U, 0x86U, 0xD0U, 0x15U, 0x62U, 0x10U, 0xB2U,
	0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x0FU,
};
static const u8 XRsa_EccCurve25519D10[] = {
	0xD4U, 0xE8U, 0x01U, 0xD3U, 0xEFU, 0xE8U, 0x72U, 0xE3U,
	0xCDU, 0xBEU, 0xCAU, 0x36U, 0x5FU, 0xDBU, 0x24U, 0xADU,
	0x71U, 0x5FU, 0x6EU, 0x5AU, 0x3EU, 0x57U, 0xEEU, 0xF2U,
	0xB4U, 0x31U, 0xA3U, 0x97U, 0xAAU, 0x63U, 0x5CU, 0x0BU,
};
static const u8 XRsa_EccCurve25519D11[] = {
	0x01U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
};
static const u8 XRsa_EccCurve25519D12[] = {
	0xEDU, 0xD3U, 0xF5U, 0x5CU, 0x1AU, 0x63U, 0x12U, 0x58U,
	0xD6U, 0x9CU, 0xF7U, 0xA2U, 0xDEU, 0xF9U, 0xDEU, 0x14U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x10U,
};
static const u8 XRsa_EccCurve25519D13[] = {
	9,  3,  1,	1,	// 256
};
static const u8 XRsa_EccCurve25519D14[] = {
	0x68U, 0x9FU, 0xAEU, 0xE7U, 0xD2U, 0x18U, 0x93U, 0xC0U,
	0xB2U, 0xE6U, 0xBCU, 0x17U, 0xF5U, 0xCEU, 0xF7U, 0xA6U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x80U,
};
#define XRsa_EccCurve25519D15 0
#define XRsa_EccCurve25519D16 3 //  log2 (cofactor)

#endif /* XASU_ECC_SUPPORT_EDWARD_P25519 */

#ifdef XASU_ECC_SUPPORT_EDWARD_P448
static const u8 XRsa_EccP448D0[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xC2U, 0x69U, 0x1CU, 0xC3U,
	0x6CU, 0xB2U, 0x2FU, 0x6BU, 0x73U, 0x69U, 0x84U, 0xC5U,
	0xD3U, 0x19U, 0xD3U, 0xB8U, 0x0CU, 0x62U, 0x51U, 0x2BU,
	0x31U, 0x5AU, 0xE3U, 0x03U, 0x44U, 0xCBU, 0x86U, 0xA6U,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x3FU,
	0xF1U, 0x62U, 0xA4U, 0x2BU, 0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP448D1[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccP448D2[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x56U, 0x67U, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0x56U, 0x67U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP448D3[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP448D4[] = {
	0x5EU, 0xC0U, 0x0CU, 0xC7U, 0x2BU, 0xA8U, 0x26U, 0x26U,
	0x8EU, 0x93U, 0x00U, 0x8BU, 0xE1U, 0x80U, 0x3BU, 0x43U,
	0x11U, 0x65U, 0xB6U, 0x2AU, 0xF7U, 0x1AU, 0xAEU, 0x12U,
	0x64U, 0xA4U, 0xD3U, 0xA3U, 0x24U, 0xE3U, 0x6DU, 0xEAU,
	0x67U, 0x17U, 0x0FU, 0x47U, 0x70U, 0x65U, 0x14U, 0x9EU,
	0xDAU, 0x36U, 0xBFU, 0x22U, 0xA6U, 0x15U, 0x1DU, 0x22U,
	0xEDU, 0x0DU, 0xEDU, 0x6BU, 0xC6U, 0x70U, 0x19U, 0x4FU,
	0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP448D5[] = {
...
static const u8 XRsa_EccP448D6[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccP448D7[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x01U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP448D8[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x02U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP448D9[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x34U, 0xECU, 0x9EU, 0x52U,
	0xB5U, 0xF5U, 0x1CU, 0x72U, 0xABU, 0xC2U, 0xE9U, 0xC8U,
	0x35U, 0xF6U, 0x4CU, 0x7AU, 0xBFU, 0x25U, 0xA7U, 0x44U,
	0xD9U, 0x92U, 0xC4U, 0xEEU, 0x58U, 0x70U, 0xD7U, 0x0CU,
	0x02U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP448D10[] = {
	0xEAU, 0x63U, 0xBFU, 0x89U, 0x57U, 0x6CU, 0x84U, 0xDEU,
	0x8EU, 0xD4U, 0x99U, 0x56U, 0x41U, 0x5CU, 0x31U, 0x1FU,
	0xA6U, 0x90U, 0xAFU, 0x30U, 0x27U, 0xEEU, 0x5BU, 0xB1U,
	0x7FU, 0x23U, 0x57U, 0x34U, 0xE1U, 0x94U, 0xDAU, 0x88U,
	0xAFU, 0x9CU, 0x70U, 0xBFU, 0xEFU, 0x98U, 0x0AU, 0xF1U,
	0x08U, 0xE8U, 0xD0U, 0x94U, 0xBAU, 0x50U, 0x75U, 0x10U,
	0xAAU, 0x0FU, 0x86U, 0xC9U, 0x72U, 0xCFU, 0x17U, 0x2EU,
	0x00U, 0x00U, 0x00U, 0x00U,
};

static const u8 XRsa_EccP448D11[] = {
	0x01U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccP448D12[] = {
...
static const u8 XRsa_EccP448D13[] = {
	16, 5,  2,	2,	// 480
};

static const u8 XRsa_EccP448D14[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccCurve448D0[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xC2U, 0x69U, 0x1CU, 0xC3U,
	0x6CU, 0xB2U, 0x2FU, 0x6BU, 0x73U, 0x69U, 0x84U, 0xC5U,
	0xD3U, 0x19U, 0xD3U, 0xB8U, 0x0CU, 0x62U, 0x51U, 0x2BU,
	0x31U, 0x5AU, 0xE3U, 0x03U, 0x44U, 0xCBU, 0x86U, 0xA6U,
...
static const u8 XRsa_EccCurve448D1[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccCurve448D2[] = {
	0xA9U, 0x98U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
#define XRsa_EccCurve448D3 XRsa_EccCurve448D10
static const u8 XRsa_EccCurve448D4[] = {
...
#define XRsa_EccCurve448D5 0
static const u8 XRsa_EccCurve448D6[] = {
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccCurve448D7[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x01U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccCurve448D8[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x02U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccCurve448D9[] = {
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x34U, 0xECU, 0x9EU, 0x52U,
	0xB5U, 0xF5U, 0x1CU, 0x72U, 0xABU, 0xC2U, 0xE9U, 0xC8U,
	0x35U, 0xF6U, 0x4CU, 0x7AU, 0xBFU, 0x25U, 0xA7U, 0x44U,
...
static const u8 XRsa_EccCurve448D10[] = {
	0xEAU, 0x63U, 0xBFU, 0x89U, 0x57U, 0x6CU, 0x84U, 0xDEU,
	0x8EU, 0xD4U, 0x99U, 0x56U, 0x41U, 0x5CU, 0x31U, 0x1FU,
	0xA6U, 0x90U, 0xAFU, 0x30U, 0x27U, 0xEEU, 0x5BU, 0xB1U,
	0x7FU, 0x23U, 0x57U, 0x34U, 0xE1U, 0x94U, 0xDAU, 0x88U,
...
static const u8 XRsa_EccCurve448D11[] = {
	0x01U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
	0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
static const u8 XRsa_EccCurve448D12[] = {
	0xF3U, 0x44U, 0x58U, 0xABU, 0x92U, 0xC2U, 0x78U, 0x23U,
	0x55U, 0x8FU, 0xC5U, 0x8DU, 0x72U, 0xC2U, 0x6CU, 0x21U,
	0x90U, 0x36U, 0xD6U, 0xAEU, 0x49U, 0xDBU, 0x4EU, 0xC4U,
	0xE9U, 0x23U, 0xCAU, 0x7CU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
...
static const u8 XRsa_EccCurve448D13[] = {
	16, 5,  2,	2,	// 480
};
static const u8 XRsa_EccCurve448D14[] = {
	0xCCU, 0x13U, 0x61U, 0xADU, 0x4AU, 0x0AU, 0xE3U, 0x8DU,
	0x54U, 0x3DU, 0x16U, 0x37U, 0xCAU, 0x09U, 0xB3U, 0x85U,
	0x40U, 0xDAU, 0x58U, 0xBBU, 0x26U, 0x6DU, 0x3BU, 0x11U,
	0xA7U, 0x8FU, 0x28U, 0xF3U, 0xFDU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
	0x00U,
};
#define XRsa_EccCurve448D15 0
#define XRsa_EccCurve448D16 2  // log2(cofactor)
...
EcdsaCrvInfo XRsa_EccCrvsDb[] = {
	...
	},
	{
		...
		256U,
		ECDSA_MONTGOMERY,
		XRsa_EccCurve25519D0,
		XRsa_EccCurve25519D1,
		XRsa_EccCurve25519D2,
		XRsa_EccCurve25519D3,
		XRsa_EccCurve25519D4,
		XRsa_EccCurve25519D5,
		XRsa_EccCurve25519D6,
		XRsa_EccCurve25519D7,
		XRsa_EccCurve25519D8,
		XRsa_EccCurve25519D9,
		XRsa_EccCurve25519D10,
		XRsa_EccCurve25519D11,
		XRsa_EccCurve25519D12,
		XRsa_EccCurve25519D13,
		XRsa_EccCurve25519D14,
		XRsa_EccCurve25519D15,
		XRsa_EccCurve25519D16,
	},
#endif /* XASU_ECC_SUPPORT_EDWARD_P25519 */
