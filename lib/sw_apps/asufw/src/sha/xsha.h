...
#define XSHA_NON_BLOCKING_CMD_STAGE_INIT			(0x0U) /**< Initial command stage
									value for SHA operations */
#define XSHA_NON_BLOCKING_CMD_STAGE_UPDATE_IN_PROGRESS		(0x1U) /**< SHA update command stage
									for DMA non-blocking wait */
