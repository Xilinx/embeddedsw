...
#ifndef ENABLE_MEM_RANGE_PM_FPGA_READ_BACK_VAL
#define ENABLE_MEM_RANGE_PM_FPGA_READ_BACK_VAL		(1U)
#endif
...
#if (ENABLE_MEM_RANGE_PM_FPGA_READ_BACK_VAL) && (!defined(ENABLE_MEM_RANGE_PM_FPGA_READ_BACK))
#define ENABLE_MEM_RANGE_PM_FPGA_READ_BACK
#endif
