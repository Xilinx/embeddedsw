...
BSP_DIR=$WORKING_DIR/versalnet_plm_bsp/psx_pmc_0

#processor dir
PROC_DIRNAME=cpu

# Embedded Sw dir relative path from versalnet_plm src
...
BSP_SEQUENTIAL_MAKEFILES="$BSP_SEQUENTIAL_MAKEFILES $BSP_DIR/libsrc/xilpm/src/versal_net/common/Makefile"
