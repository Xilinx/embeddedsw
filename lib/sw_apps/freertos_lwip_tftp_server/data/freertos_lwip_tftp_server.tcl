...
proc swapp_get_name {} {
    return "FreeRTOS lwIP tftp server";
}

proc swapp_get_description {} {
    return "The FreeRTOS lwIP tftp server application provides a simple demonstration of how to use the light-weight IP stack (lwIP) to implement a tftp server. This application sets up the board to use default IP address 192.168.1.10 (in absence of DHCP server), with MAC address 00:0a:35:00:01:02."
}
