...
# first input parameter is used for identifying the board
BOARD=$1
...
if [ $BOARD == "su10p" ] || [ $BOARD == "su25p" ] || [ $BOARD == "su35p" ] || [ $BOARD == "SU10P" ] || [ $BOARD == "SU25P" ] || [ $BOARD == "SU35P" ]; then
    cp $WORKING_DIR/xparameters_su35p.h $BSP_DIR/include/xparameters.h
else
