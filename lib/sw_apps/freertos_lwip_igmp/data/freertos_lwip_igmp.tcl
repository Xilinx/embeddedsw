...
proc swapp_get_name {} {
    return "FreeRTOS lwIP IGMP";
}

proc swapp_get_description {} {
    return "The FreeRTOS lwIP IGMP application provides a simple demonstration of how to use IGMP protocol with light-weight IP stack (lwIP). This application sets up the board to use IP address 192.168.1.10, with MAC address 00:0a:35:00:01:02. The application joins Multicast group 224.10.10.3 and waits for multicast packets of same group on default 5001 port."
}
