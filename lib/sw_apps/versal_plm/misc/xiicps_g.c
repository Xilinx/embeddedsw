...
XIicPs_Config XIicPs_ConfigTable[XPAR_XIICPS_NUM_INSTANCES] =
{
	...
	{
		XPAR_VERSAL_CIPS_0_PSPMC_0_PSV_PMC_I2C_0_DEVICE_ID,
		XPAR_VERSAL_CIPS_0_PSPMC_0_PSV_PMC_I2C_0_BASEADDR,
		XPAR_VERSAL_CIPS_0_PSPMC_0_PSV_PMC_I2C_0_I2C_CLK_FREQ_HZ
	}
};
