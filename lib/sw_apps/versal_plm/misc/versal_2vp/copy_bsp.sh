...
# Embedded Sw dir relative path from versal_2vp_plm src
...
cp -r $SERVICES_DIR/xilplmi/src/versal_2vp/server/* $BSP_DIR/libsrc/xilplmi/src/
cp -r $SERVICES_DIR/xilplmi/src/versal_2vp/common/* $BSP_DIR/libsrc/xilplmi/src/
...
cp -r $SERVICES_DIR/xilloader/src/versal_2vp/server/* $BSP_DIR/libsrc/xilloader/src/
...
cp $SERVICES_DIR/xilnvm/src/versal_gen/common/* $BSP_DIR/libsrc/xilnvm/src/
