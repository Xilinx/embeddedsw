...
# present working dir
WORKING_DIR=../../misc/versal_2vp_p

# Versal misc dir
VERSAL_MISC_DIR=../../misc/versal
...
# Embedded Sw dir relative path from versal_2vp_p src
...
cp -r $SERVICES_DIR/xilpdi/src/versal_2vp_p/* $BSP_DIR/libsrc/xilpdi/src/
cp -r $SERVICES_DIR/xilpdi/src/versal_2vp_p/*.h $BSP_DIR/include/
...
cp -r $SERVICES_DIR/xilplmi/src/versal_2vp_p/server/* $BSP_DIR/libsrc/xilplmi/src/
cp -r $SERVICES_DIR/xilplmi/src/versal_2vp_p/common/* $BSP_DIR/libsrc/xilplmi/src/
cp -r $SERVICES_DIR/xilplmi/src/versal_net/server/xplmi_wdt.* $BSP_DIR/libsrc/xilplmi/src/
cp -r $SERVICES_DIR/xilplmi/src/versal_net/server/xplmi_update.* $BSP_DIR/libsrc/xilplmi/src/
...
cp -r $SERVICES_DIR/xilpuf/src/versal_2vp_p/server/* $BSP_DIR/libsrc/xilpuf/src
...
cp -r $SERVICES_DIR/xilloader/src/versal_2vp_p/server/* $BSP_DIR/libsrc/xilloader/src/
...
cp -r $SERVICES_DIR/xilsecure/src/server/core/slhdsa/* $BSP_DIR/libsrc/xilsecure/src/
cp -r $SERVICES_DIR/xilsecure/src/common/versal_2vp_p/* $BSP_DIR/libsrc/xilsecure/src/
...
cp $VERSAL_MISC_DIR/bspconfig.h $BSP_DIR/libsrc/standalone/src/
cp $VERSAL_MISC_DIR/microblaze_interrupts_g.c $BSP_DIR/libsrc/standalone/src/
cp $VERSAL_MISC_DIR/bspconfig.h  $BSP_DIR/include/
cp $WORKING_DIR/Makefile $BSP_DIR/../
cp $WORKING_DIR/dep.mk $BSP_DIR/../
cp $VERSAL_MISC_DIR/xsysmonpsv_supplylist.h $BSP_DIR/include/
...
# copy all the HSM generated driver files DRIVER_g.c
	cp $VERSAL_MISC_DIR/x"$line"_g.c $BSP_DIR/libsrc/$line/src/
done < $DRIVERS_LIST
...
cp $VERSAL_MISC_DIR/config.make $BSP_DIR/libsrc/standalone/src/
cp $VERSAL_MISC_DIR/xtmr_manager_g.c $BSP_DIR/libsrc/tmr_manager/src/
cp $VERSAL_MISC_DIR/xtmr_inject_g.c $BSP_DIR/libsrc/tmr_inject/src/
cp $VERSAL_MISC_DIR/xttcps_g.c $BSP_DIR/libsrc/ttcps/src/
cp $VERSAL_MISC_DIR/xpmonpsv_g.c $BSP_DIR/libsrc/pmonpsv/src/
cp $VERSAL_MISC_DIR/xgpiops_g.c $BSP_DIR/libsrc/gpiops/src/
cp $VERSAL_MISC_DIR/xqspipsu_g.c $BSP_DIR/libsrc/qspipsu/src/
cp $VERSAL_MISC_DIR/xrtcpsu_g.c $BSP_DIR/libsrc/rtcpsu/src/
cp $VERSAL_MISC_DIR/xsdps_g.c $BSP_DIR/libsrc/sdps/src/
cp $VERSAL_MISC_DIR/xuartlite_g.c $BSP_DIR/libsrc/uartlite/src/
cp $VERSAL_MISC_DIR/xsysmonpsv_supplylist.h $BSP_DIR/libsrc/sysmonpsv/src/
...
cp $VERSAL_MISC_DIR/microblaze_exceptions_g.h $BSP_DIR/libsrc/standalone/src/

# no inbyte and outbyte present in standalone
cp $VERSAL_MISC_DIR/inbyte.c $VERSAL_MISC_DIR/outbyte.c  $BSP_DIR/libsrc/standalone/src/
