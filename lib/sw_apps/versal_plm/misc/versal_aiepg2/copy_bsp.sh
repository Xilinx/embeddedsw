...
# present working dir
WORKING_DIR=../../misc/versal_aiepg2
...
cp -r $SERVICES_DIR/xilpdi/src/versal_aiepg2/* $BSP_DIR/libsrc/xilpdi/src
cp -r $SERVICES_DIR/xilpdi/src/versal_aiepg2/*.h $BSP_DIR/include/
...
cp -r $SERVICES_DIR/xilplmi/src/versal_aiepg2/* $BSP_DIR/libsrc/xilplmi/src/
...
cp -r $SERVICES_DIR/xilloader/src/versal_aiepg2/* $BSP_DIR/libsrc/xilloader/src/
...
cp -r $SERVICES_DIR/xilloader/src/versal_aiepg2/*.h $BSP_DIR/include/
...
cp -r $SERVICES_DIR/xilsecure/src/common/versal_aiepg2/* $BSP_DIR/libsrc/xilsecure/src/
cp -r $SERVICES_DIR/xilsecure/src/server/versal_aiepg2/* $BSP_DIR/libsrc/xilsecure/src/
