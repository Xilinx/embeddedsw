...
/**
*
* @file versal_2vp/versal_2vp/xplm_plat.c
*
...
/**************************************************************************************************/
/**
 * @brief	This function configures the NPLL equal to slave SLR ROM NPLL frequency. It is only
 * 		required for master SLR devices.
 *
 * @return
...
int XPlm_ConfigureDefaultNPll(void)
{
	...
	/* Check for NPLL lock */
	Status = XPlmi_UtilPoll(CRP_PLL_STATUS, CRP_PLL_STATUS_NOCPLL_LOCK_MASK,
			CRP_PLL_STATUS_NOCPLL_LOCK_MASK, NOCPLL_TIMEOUT, NULL);
