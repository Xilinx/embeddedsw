...
#define XPSMFW_DEV_CLUSTER0_ACPU_0      (0x1810c003U)
#define XPSMFW_DEV_CLUSTER0_ACPU_1      (0x1810c004U)
#define XPSMFW_DEV_CLUSTER0_ACPU_2      (0x1810c005U)
#define XPSMFW_DEV_CLUSTER0_ACPU_3      (0x1810c006U)

#define XPSMFW_DEV_CLUSTER1_ACPU_0      (0x1810c007U)
#define XPSMFW_DEV_CLUSTER1_ACPU_1      (0x1810c008U)
#define XPSMFW_DEV_CLUSTER1_ACPU_2      (0x1810c009U)
#define XPSMFW_DEV_CLUSTER1_ACPU_3      (0x1810c00aU)

#define XPSMFW_DEV_CLUSTER2_ACPU_0      (0x1810c00bU)
#define XPSMFW_DEV_CLUSTER2_ACPU_1      (0x1810c00cU)
#define XPSMFW_DEV_CLUSTER2_ACPU_2      (0x1810c00dU)
#define XPSMFW_DEV_CLUSTER2_ACPU_3      (0x1810c00eU)

#define XPSMFW_DEV_CLUSTER3_ACPU_0      (0x1810c00fU)
#define XPSMFW_DEV_CLUSTER3_ACPU_1      (0x1810c010U)
#define XPSMFW_DEV_CLUSTER3_ACPU_2      (0x1810c011U)
#define XPSMFW_DEV_CLUSTER3_ACPU_3      (0x1810c012U)

#define XPSMFW_DEV_CLUSTER0_RPU0_0      (0x18110013U)
#define XPSMFW_DEV_CLUSTER0_RPU0_1      (0x18110014U)

#define XPSMFW_DEV_CLUSTER1_RPU0_0      (0x18110015U)
#define XPSMFW_DEV_CLUSTER1_RPU0_1      (0x18110016U)
