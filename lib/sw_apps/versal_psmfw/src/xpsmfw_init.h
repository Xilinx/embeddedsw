...
#define IDCODE_DEV_80				(0x00028000U)
#define IDCODE_DEV_80_SVD_2			(0x0002A000U)
#define IDCODE_DEV_SBFMLY_S80			(IDCODE_SBFMLY_S | IDCODE_DEV_80)
#define IDCODE_DEV_SBFMLY_S80_SVD_2		(IDCODE_SBFMLY_S | IDCODE_DEV_80_SVD_2)
