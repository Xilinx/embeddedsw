function onPageLoad() {
	...
	http.onload = function() {
		...
		table.rows[0].cells[1].innerHTML = obj.SysBoardInfo.BrdName;
		table.rows[1].cells[1].innerHTML = obj.SysBoardInfo.RevisionNo;
		table.rows[2].cells[1].innerHTML = obj.SysBoardInfo.SerialNo;
		table.rows[3].cells[1].innerHTML = obj.SysBoardInfo.State;
		table.rows[4].cells[1].innerHTML = obj.SysBoardInfo.PartNo;
		table.rows[5].cells[1].innerHTML = obj.SysBoardInfo.UUID;
