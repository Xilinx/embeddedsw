function onPageLoad() {
	...
	http.onload = function() {
		...
		table.rows[5].cells[1].innerHTML = obj.SysBoardInfo.PrimaryBootDevMem;
		table.rows[6].cells[1].innerHTML = obj.SysBoardInfo.SecondaryBootDevMem;
		table.rows[7].cells[1].innerHTML = obj.SysBoardInfo.PsDdr;
		table.rows[8].cells[1].innerHTML = obj.SysBoardInfo.PlDdr;
...
function initiateImgUpload (evt) {
	var imgId = 'A';
	var imgFile = document.getElementById("img_file").files[0];
