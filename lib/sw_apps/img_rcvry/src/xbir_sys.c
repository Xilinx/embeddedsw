...
* 7.01  sd    07/18/24   Aligned Ethernet MIO's as per hardware design
* 8.00  sd    10/02/24   Update frequency divisor values for GEM interfaces
*
* </pre>
*
******************************************************************************/
...
#define IOU_SLCR_BANK1_CTRL5_OFFSET	(0xFF180164U)
...
static int Xbir_KREthInit (void)
{
	...
	Xbir_MaskWrite(IOU_SLCR_BANK1_CTRL5_OFFSET, 0x00003FFFU, 0x0000357FU);
...
static int Xbir_KDEthInit (void)
{
	...
	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI2_OFFSET, 0x00003FFFU, 0x0000000BU);
	Xbir_MaskWrite(IOU_SLCR_BANK1_CTRL5_OFFSET, 0x00003FFFU, 0x0000303FU);
	Xbir_MaskWrite(CRL_APB_RST_LPD_IOU0_OFFSET, 0x00000003U, 0x00000000U);
