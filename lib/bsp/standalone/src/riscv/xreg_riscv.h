...
#define XREG_MHPMEVENT3				mhpmevent3h    /* 0x323      */
#define XREG_MHPMEVENT4				mhpmevent4h    /* 0x324      */
#define XREG_MHPMEVENT5				mhpmevent5h    /* 0x325      */
#define XREG_MHPMEVENT6				mhpmevent6h    /* 0x326      */
#define XREG_MHPMEVENT7				mhpmevent7h    /* 0x327      */
#define XREG_MHPMEVENT8				mhpmevent8h    /* 0x328      */
#define XREG_MHPMEVENT9				mhpmevent9h    /* 0x329      */
#define XREG_MHPMEVENT10			mhpmevent10h   /* 0x32A      */
#define XREG_MHPMEVENT11			mhpmevent11h   /* 0x32B      */
#define XREG_MHPMEVENT12			mhpmevent12h   /* 0x32C      */
#define XREG_MHPMEVENT13			mhpmevent13h   /* 0x32D      */
#define XREG_MHPMEVENT14			mhpmevent14h   /* 0x32E      */
#define XREG_MHPMEVENT15			mhpmevent15h   /* 0x32F      */
#define XREG_MHPMEVENT16			mhpmevent16h   /* 0x330      */
#define XREG_MHPMEVENT17			mhpmevent17h   /* 0x331      */
#define XREG_MHPMEVENT18			mhpmevent18h   /* 0x332      */
#define XREG_MHPMEVENT19			mhpmevent19h   /* 0x333      */
#define XREG_MHPMEVENT20			mhpmevent20h   /* 0x334      */
#define XREG_MHPMEVENT21			mhpmevent21h   /* 0x335      */
#define XREG_MHPMEVENT22			mhpmevent22h   /* 0x336      */
#define XREG_MHPMEVENT23			mhpmevent23h   /* 0x337      */
#define XREG_MHPMEVENT24			mhpmevent24h   /* 0x338      */
#define XREG_MHPMEVENT25			mhpmevent25h   /* 0x339      */
#define XREG_MHPMEVENT26			mhpmevent26h   /* 0x33A      */
#define XREG_MHPMEVENT27			mhpmevent27h   /* 0x33B      */
#define XREG_MHPMEVENT28			mhpmevent28h   /* 0x33C      */
#define XREG_MHPMEVENT29			mhpmevent29h   /* 0x33D      */
#define XREG_MHPMEVENT30			mhpmevent30h   /* 0x33E      */
#define XREG_MHPMEVENT31			mhpmevent31h   /* 0x33F      */
