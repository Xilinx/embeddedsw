...
/*---------------------------------------------------*/
/* It supports below formats for 32 bit              */
/* and 64 platforms                                  */
/*                                                   */
/* %c, %s, %d, %ld, %lld, %u, %p                     */
/* %i, %x, %lx, %llx                                 */
/* It also supports padding                          */
/* (number with a certain width)                     */
/* e.g:("%05d",6); it will pad 4 zeros before 6      */
/* output:00006                                      */
/* e.g:("%5d",6);It will pad 4 spaces before 6       */
/* output:    6                                      */
/*---------------------------------------------------*/
