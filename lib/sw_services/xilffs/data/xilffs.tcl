...
proc get_ffs_periphs {processor} {
	...
	foreach periph $periphs_list {
		...
		if {$periphname == "ps7_sdio" || $periphname == "psu_sd" || $periphname == "psv_pmc_sd" || $periphname == "psxl_pmc_sd" || $periphname == "psxl_pmc_emmc"} {
...
proc xgen_opts_file {libhandle} {
	...
	foreach periph $ffs_periphs_name_list {
		...
		if {$periph == "ps7_sdio" || $periph == "psu_sd" || $periph == "psv_pmc_sd" || $periph == "psxl_pmc_sd" || $periph == "psxl_pmc_emmc"} {
			if {$fs_interface == 1} {
