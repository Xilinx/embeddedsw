...
#define PSX_RPU_CLUSTER_A0_CORE_0_PWRDWN	(0xEB588200U)
#define PSX_RPU_CLUSTER_A1_CORE_1_PWRDWN	(0xEB58C200U)
#define PSX_RPU_CLUSTER_B0_CORE_0_PWRDWN	(0xEB598200U)
#define PSX_RPU_CLUSTER_B1_CORE_1_PWRDWN	(0xEB59C200U)
#define PSX_RPU_CLUSTER_C0_CORE_0_PWRDWN	(0xEB5A8200U)
#define PSX_RPU_CLUSTER_C1_CORE_1_PWRDWN	(0xEB5AC200U)
#define PSX_RPU_CLUSTER_D0_CORE_0_PWRDWN	(0xEB5B8200U)
#define PSX_RPU_CLUSTER_D1_CORE_1_PWRDWN	(0xEB5BC200U)
#define PSX_RPU_CLUSTER_E0_CORE_0_PWRDWN	(0xEB5C8200U)
#define PSX_RPU_CLUSTER_E1_CORE_1_PWRDWN	(0xEB5CC200U)
...
#define DEFINE_RPU_PROC(cluster_name, core_num) \
	static struct XPm_Proc Proc_RPU_ ## cluster_name ## _ ## core_num = { \
		...
		.PwrCtrl = PSX_RPU_CLUSTER_## cluster_name ## core_num ##_CORE_## core_num ##_PWRDWN, \
