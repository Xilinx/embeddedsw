...
static int CheckAndCompareHashFromIHTOptionalData(XilPdi *PdiPtr, u8 *HashPtr, u32 PrtnHashIndex);
			...
			XilPdi_MetaHdr *MetaHdr)
{
	...
	if (SecurePtr->PdiPtr->MetaHdr.IsAuthOptimized == (u32)TRUE) {
		 ...
		 */
		XSECURE_TEMPORAL_IMPL(Status, StatusTmp, CheckAndCompareHashFromIHTOptionalData,
