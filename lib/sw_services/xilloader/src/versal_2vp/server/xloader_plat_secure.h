...
/**
 * @addtogroup xloader_apis XilLoader versal_2vp APIs
 * @{
 */
...
typedef enum {
	...
	XLOADER_ERR_RESERVED_30,
		/**< 0x30 XLOADER_ERR_RESERVED_30 */
...
/**************************************************************************************************/
/**
 * @brief	This function is supported only for Versalnet, nothing to be done in Versal_2vp.
 *
 * @return
 * 		- XST_SUCCESS always.
 *
