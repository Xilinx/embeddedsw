...
/**************************************************************************************************/
/**
 * @brief	This function is used to check if the given NodeId is applicable for DFx.
 *
...
{
	/* Not applicable for Versal 2VP_P */
	return;
}
