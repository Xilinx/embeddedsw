...
/**
*
* @file versal_2vp_p/xilpdi_plat.h
*
* This is the header file which contains versal_2vp_p specific definitions
* for the PDI.
*
* <pre>
 ...
 */
#define XIH_BH_META_HDR_OFFSET				(0x2D4U)

/**
 * Boot header address in PRAM copied by ROM
 */
#define XIH_BH_PRAM_ADDR			(0xF201EE00U)
...
typedef struct {
	...
	u32 UserData[128U]; /**< User Data */
	u32 HashAlgoUsed; /**< Hash Algorithm used for HashBlock */
