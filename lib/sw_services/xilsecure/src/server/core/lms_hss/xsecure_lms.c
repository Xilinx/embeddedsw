...
/**
*
* @file server/core/lms_hss/xsecure_lms.c
*
	...
	XSecure_LmsParam** Parameters)
{
	...
	/** - Return the parameter for below LMS types */
	static XSecure_LmsParam XSecure_LmsParamLookup[XSECURE_LMS_TYPE_MAX_SUPPORTED] = {
		...
		[1U] = {
			...
			.mh = (XSECURE_SHA2_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H5)
		},
		...
		[2U] = {
			...
			.mh = (XSECURE_SHA2_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H10)
		},
		...
		[3U] = {
			...
			.mh = (XSECURE_SHA2_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H15)
		},
		...
		[4U] = {
			...
			.mh = (XSECURE_SHA2_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H20)
		},
		...
		[5U] = {
			...
			.h = XSECURE_LMS_TREE_HEIGHT_H5,
			.mh = (XSECURE_SHAKE_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H5)
		},
		...
		[6U] = {
			...
			.m = XSECURE_SHAKE_256_HASH_LEN,
			.h = XSECURE_LMS_TREE_HEIGHT_H10,
			.mh = (XSECURE_SHAKE_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H10)
		},
		...
		[7U] = {
			...
			.m = XSECURE_SHAKE_256_HASH_LEN,
			.h = XSECURE_LMS_TREE_HEIGHT_H15,
			.mh = (XSECURE_SHAKE_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H15)
		},
		...
		[8U] = {
			...
			.m = XSECURE_SHAKE_256_HASH_LEN,
			.h = XSECURE_LMS_TREE_HEIGHT_H20,
			.mh = (XSECURE_SHAKE_256_HASH_LEN * (u32)XSECURE_LMS_TREE_HEIGHT_H20)
		}
	};
