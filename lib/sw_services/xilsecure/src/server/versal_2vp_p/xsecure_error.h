...
/**
 *
 * @file server/versal_2vp_p/xsecure_error.h
 *
...
enum {
	...
	XSECURE_HMAC_KAT_INIT_ERROR,		/**< 0x8A - HMAC init failure */
	XSECURE_HMAC_KAT_UPDATE_ERROR,		/**< 0x8B - HMAC update failure */
	XSECURE_HMAC_KAT_FINAL_ERROR,		/**< 0x8C - HMAC final failure */
	XSECURE_HMAC_KAT_ERROR,			/**< 0x8D - HMAC KAT error */
	XSECURE_HMAC_INVALID_PARAM,		/**< 0x8E - HMAC invalid parameter */
