...
/**
*
* @file server/versal_2vp_p/xsecure_plat_kat_ipihandler.c
*
...
/**************************************************************************************************/
/**
 * @brief	This function handler calls XSecure_Sha2256Kat server API and and updates KAT status
 * 		to XPLMI_RTCFG_PLM_KAT_ADDR address.
 *
 * @return
