...
#define ELLIPTIC_SUCCESS		(0x0)	/**< Return value in case of success */
...
externC int Ecdsa_VerifySign(EcdsaCrvInfo* CrvInfo, u8* Hash, u32 HashLen, EcdsaKey* Key,
		EcdsaSign* Sign);

externC int Ecdsa_GenerateSign(EcdsaCrvInfo* CrvInfo, u8* Hash, u32 HashLen, const u8* D,
