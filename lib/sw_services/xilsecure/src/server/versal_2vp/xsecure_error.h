...
enum {
	...
	XSECURE_AESDPACM_KAT_CHECK1_FAILED_ERROR,    /**< 0x4C - Error when AESDPACM
							data not matched with expected data  */
	...
	XSECURE_AES_DEVICE_KEY_NOT_ALLOWED,	     /**< 0x54 - Access to device keys
							is not allowed for IPI for any operations */
	...
	XSECURE_AES_KAT_ENCRYPT_INIT_FAILED_ERROR,	/**< 0x57 - Error when encrypt init fails */
	XSECURE_AES_KAT_ENCRYPT_UPDATE_FAILED_ERROR,	/**< 0x58 - Error when encrypt update fails */
	XSECURE_AES_KAT_ENCRYPT_FINAL_FAILED_ERROR,	/**< 0x59 - Error when encrypt final fails */
	XSECURE_KAT_GCM_TAG_MISMATCH_ERROR,	/**< 0x5A - Error when GCM mismatch occurs */
	XSECURE_AES_ZERO_PUF_KEY_NOT_ALLOWED,	/**< 0x5B - Error when PUF Key is selected as key
						  source and PUF key is zeroized */
	...
	XSECURE_AES_DMA_COMPONENT_IS_NOT_READY,	/**< 0X5E - Error when DMA component is not ready */
	...
	XSECURE_IPI_ACCESS_NOT_ALLOWED,	/**< 0xF1 - Access to Xilsecure IPIs is disabled if IPI
					  request is non secure */
