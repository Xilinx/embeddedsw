...
/**
*
* @file client/versal_2vp/xsecure_plat_katclient.c
*
...
int XSecure_TrngKat(XSecure_ClientInstance *InstancePtr)
{
	...
	/**
	 * - Send an IPI request to the PLM by using the CDO command to call XSecure_TrngKat API and
