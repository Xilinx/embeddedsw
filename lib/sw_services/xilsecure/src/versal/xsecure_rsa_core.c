...
u32 XSecure_RsaOperation(XSecure_Rsa *InstancePtr, u8 *Input,
			u8 *Result, u8 RsaOp, u32 KeySize)
{
	u32 Status = (u32)XST_FAILURE;
...
/**
 * @brief
* This function updates data length configuration
*
* @param	InstancePtr	Pointer to the XSecure_Rsa instance.
...
u32 XSecure_RsaPublicEncryptKat(void)
{
	...
	const u32 PubExponent = 0x1000100U;
	const u32 PubMod[XSECURE_RSA_4096_SIZE_WORDS] = {
	...
	const u32 PubModExt[XSECURE_RSA_4096_SIZE_WORDS] = {
	...
	const u32 RsaData[XSECURE_RSA_4096_SIZE_WORDS] = {
	...
	const u32 ExpectedOuptut[XSECURE_RSA_4096_SIZE_WORDS] = {
