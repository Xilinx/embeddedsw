...
if(("${CMAKE_MACHINE}" STREQUAL "Versal") OR ("${CMAKE_MACHINE}" STREQUAL "VersalNet"))
  ...
  if(("${CMAKE_MACHINE}" STREQUAL "VersalNet") OR ("Versal_2VP" IN_LIST VARIANT) OR ("Versal_2VP_P" IN_LIST VARIANT))
    ...
    if(("${CMAKE_MACHINE}" STREQUAL "VersalNet") OR ("Versal_2VP_P" IN_LIST VARIANT))
