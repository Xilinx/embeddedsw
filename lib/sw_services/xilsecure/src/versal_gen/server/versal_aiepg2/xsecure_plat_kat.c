...
#define XSECURE_LMS_SIGNATURE_SIZE_BYTES	(4464U)
...
static u8 Signature_Shake256_l0h5w2[XSECURE_LMS_SIGNATURE_SIZE_BYTES] = {
...
static u8 Signature_Sha2256_l0h5w2[XSECURE_LMS_SIGNATURE_SIZE_BYTES] = {
...
static u8 Sha2_256LmsData[XSECURE_LMS_DATA_SIZE_BYTES] = {
...
static u8 Sha2256LmsData[XSECURE_LMS_DATA_SIZE_BYTES] = {
	0xE5, 0x54, 0x90, 0x9E, 0xC8, 0xF9, 0x11, 0x1F, 0x92, 0xF4, 0x77, 0x1F, 0xE8, 0xC7, 0x42, 0x07, 0xF9,
	0x83, 0x1D, 0x08, 0x30, 0xFD, 0xFD, 0xDA, 0x20, 0xA3, 0xBF, 0xD7, 0xE8, 0xEB, 0x37, 0x16, 0xEA, 0xB8,
	0x1D, 0x93, 0xE4, 0x10, 0x7D, 0x45, 0x63, 0x57, 0x59, 0x45, 0x6C, 0x93, 0x08, 0x8F, 0xA4, 0x44, 0x6D,
	0x22, 0x04, 0x91, 0x93, 0x7C
...
int XSecure_HssSha2256Kat(XSecure_Sha *ShaInstPtr, XPmcDma *DmaPtr)
{
	...
	Status = XSecure_HssInit(ShaInstPtr, DmaPtr,
		Signature_Sha2256_l0h5w2, XSECURE_LMS_SIGNATURE_SIZE_BYTES,
	...
	Status = XSecure_LmsHashMessage(ShaInstPtr,
		Sha2_256LmsData, XSECURE_LMS_DATA_SIZE_BYTES, XSECURE_SHA2_256);
	if (Status != XST_SUCCESS) {
...
int XSecure_HssShake256Kat(XSecure_Sha *ShaInstPtr, XPmcDma *DmaPtr)
{
	...
	Status = XSecure_LmsHashMessage(ShaInstPtr,
		Shake_256LmsData, XSECURE_LMS_DATA_SIZE_BYTES, XSECURE_SHAKE_256);
	if(Status != XST_SUCCESS) {
		Status = XSECURE_S3_LMS_SHAKE_256_KAT_ERROR;
		goto END;
	}
...
int XSecure_LmsSha2256Kat(XSecure_Sha *ShaInstPtr, XPmcDma *DmaPtr) {
	return XSecure_LmsSignatureVerification(ShaInstPtr, DmaPtr,
		...
		FALSE,
		Signature_Sha2256_l0h5w2,
		XSECURE_LMS_SIGNATURE_SIZE_BYTES,
		LmsSha2256PubKey,
		XSECURE_HSS_PUBLIC_KEY_TOTAL_SIZE);
}
