...
static const u8 DP[XSECURE_RSA_SIZE/2U] __attribute__ ((section (".data.DP"))) = {
...
static const u8 DQ[XSECURE_RSA_SIZE/2U] __attribute__ ((section (".data.DQ"))) = {
...
static const u8 QInv[XSECURE_RSA_SIZE/2U] __attribute__ ((section (".data.QInv"))) = {
...
static const u8 RN[XSECURE_RSA_SIZE] __attribute__ ((section (".data.RN"))) = {
...
static const u8 RRN[XSECURE_RSA_SIZE] __attribute__ ((section (".data.RRN"))) = {
