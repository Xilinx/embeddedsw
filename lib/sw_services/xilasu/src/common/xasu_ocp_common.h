...
/**
 *
 * @file xasu_ocp_common.h
 *
 * This file contains the OCP function prototypes which are common across the client and server.
 *
 * <pre>
...
#ifndef XASU_OCP_COMMON_H_
#define XASU_OCP_COMMON_H_
