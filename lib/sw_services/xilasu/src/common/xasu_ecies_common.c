...
s32 XAsu_EccValidateCurveInfo(u32 CurveType, u32 CurveLen)
{
	...
	switch (CurveType) {
		case XASU_ECC_NIST_P192:
			Len = XASU_ECC_P192_PVT_KEY_SIZE_IN_BYTES;
			break;
		case XASU_ECC_NIST_P224:
			Len = XASU_ECC_P224_PVT_KEY_SIZE_IN_BYTES;
			break;
		...
		case XASU_ECC_BRAINPOOL_P320:
			Len = XASU_ECC_P320_PVT_KEY_SIZE_IN_BYTES;
			break;
		case XASU_ECC_NIST_P384:
		case XASU_ECC_BRAINPOOL_P384:
			Len = XASU_ECC_P384_PVT_KEY_SIZE_IN_BYTES;
			break;
		case XASU_ECC_BRAINPOOL_P512:
			Len = XASU_ECC_P512_PVT_KEY_SIZE_IN_BYTES;
			break;
		case XASU_ECC_NIST_P521:
			Len = XASU_ECC_P521_PVT_KEY_SIZE_IN_BYTES;
			break;
