...
option(XILASU_rsa_keygen_2048_support "Defines key generation size for 2048 bit." OFF)
if(XILASU_rsa_keygen_2048_support )
    set(XASU_RSA_2048_KEYGEN_ENABLE " ")
endif()
option(XILASU_rsa_keygen_3072_support "Defines key generation size for 3072 bit." OFF)
if(XILASU_rsa_keygen_3072_support )
    set(XASU_RSA_3072_KEYGEN_ENABLE " ")
endif()
option(XILASU_rsa_keygen_4096_support "Defines key generation size for 4096 bit." ON)
if(XILASU_rsa_keygen_4096_support )
    set(XASU_RSA_4096_KEYGEN_ENABLE " ")
endif()
...
if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "microblaze_riscv")
    ...
    option(XILASU_ecc_p25519_support "Enables/Disables EDWARD P-25519 curve support for ECC in ASUFW." ON)
    if(XILASU_ecc_p25519_support )
        set(XASU_ECC_SUPPORT_EDWARD_P25519 " ")
    endif()

    option(XILASU_ecc_p448_support "Enables/Disables EDWARD P-448 curve support for ECC in ASUFW." ON)
    ...
    option(XILASU_ocp_support "Enables/Disables OCP support in ASUFW." ON)
    if(XILASU_ocp_support )
	set(XASU_OCP_ENABLE " ")
    endif()
    ...
    option(XILASU_keymanager_support "Enables/Disables KeyManager module in ASUFW." ON)
    if(XILASU_keymanager_support)
        set(XASU_KEYMANAGER_ENABLE " ")
    endif()
endif()
