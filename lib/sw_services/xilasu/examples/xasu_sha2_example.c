...
* 	static char Sha2Hash[ASU_SHA2_HASH_LEN_IN_BYTES]
* 				__attribute__ ((section (".data.Sha2Hash")));
...
* 1.1   ma     12/20/24 Corrected macro name
*
* </pre>
 *************************************************************************************************/
...
static char Sha2Hash[ASU_SHA2_HASH_LEN_IN_BYTES] __attribute__ ((section (".data.Sha2Hash")));
...
static s32 Asu_Sha2Example(void)
{
	...
	Xil_DCacheInvalidateRange((UINTPTR)Sha2Hash, ASU_SHA2_HASH_LEN_IN_BYTES);
#endif
 ...
 *************************************************************************************************/
  static void XAsu_Sha2CallBackRef(void *CallBackRef, u32 Status)
 {
	...
	XilAsu_Printf("Calculated SHA2 Hash \r\n ");
