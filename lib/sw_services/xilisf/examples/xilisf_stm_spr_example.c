...
static int IsfStmFlashExample(void);
...
/**
*
* Main function to call the STM Serial Flash SPR example.
*
...
int main(void)
{
	...
	xil_printf("STM Serial Flash SPR example\r\n");
	...
	if (Status != XST_SUCCESS) {
		xil_printf("STM Serial Flash SPR example Failed\r\n");
		return XST_FAILURE;
	}

	xil_printf("Successfully ran STM Serial Flash SPR example\r\n");
	return XST_SUCCESS;
}
...
/**
*
* Function to execute the STM Serial Flash SPR example.
*
* @param	None
*
