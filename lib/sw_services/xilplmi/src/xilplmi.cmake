...
if("${CMAKE_MACHINE}" STREQUAL "Versal")
  option(XILPLMI_plm_get_opt_data_en "Enables feature to get optional data" OFF)
  if(XILPLMI_plm_get_opt_data_en)
    set(PLM_GET_OPT_DATA_EN " ")
  endif()
elseif("${CMAKE_MACHINE}" STREQUAL "VersalNet")
  option(XILPLMI_plm_get_opt_data_en "Enables feature to get optional data" ON)
  if(XILPLMI_plm_get_opt_data_en)
    set(PLM_GET_OPT_DATA_EN " ")
  endif()
endif()
...
if (("${CMAKE_MACHINE}" STREQUAL "Versal") OR ("${CMAKE_SUBMACHINE}" STREQUAL "Versal_2VE_2VM"))
...
if("${CMAKE_MACHINE}" STREQUAL "Versal")
  set(XILPLMI_addr_range_validation "disable" CACHE STRING "Enables or Disables address range validation (valid only for Versal)")
  set_property(CACHE XILPLMI_addr_range_validation PROPERTY STRINGS "enable" "disable" "enable_with_debug_print")
  if("${XILPLMI_addr_range_validation}" STREQUAL "enable")
    set(PLM_ENABLE_ADDR_RANGE_VALIDATION " ")
  elseif("${XILPLMI_addr_range_validation}" STREQUAL "enable_with_debug_print")
    set(PLM_ENABLE_ADDR_RANGE_VALIDATION " ")
    set(PLM_VERIFY_ADDR_RANGE_DEBUG_PRINT " ")
  endif()
endif()

if(("${CMAKE_MACHINE}" STREQUAL "VersalNet") OR ("${CMAKE_SUBMACHINE}" STREQUAL "Versal_2VE_2VM"))
  set(XILPLMI_verify_addr_redundant_call "disable" CACHE STRING "Enables or Disables redundant address verification calls (valid only for VersalNet and Versal_2VE_2VM)")
  set_property(CACHE XILPLMI_verify_addr_redundant_call PROPERTY STRINGS "enable" "disable" "enable_with_debug_print")
  if("${XILPLMI_verify_addr_redundant_call}" STREQUAL "enable")
    set(PLM_ENABLE_VERIFY_ADDR_REDUNDANT_CALL " ")
  elseif("${XILPLMI_verify_addr_redundant_call}" STREQUAL "enable_with_debug_print")
    set(PLM_ENABLE_VERIFY_ADDR_REDUNDANT_CALL " ")
    set(PLM_VERIFY_ADDR_RANGE_DEBUG_PRINT " ")
  endif()
endif()
