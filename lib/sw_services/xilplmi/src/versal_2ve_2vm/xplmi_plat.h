...
/**
*
* @file versal_2ve_2vm/xplmi_plat.h
*
* This file contains declarations for versal_2ve_2vm specific APIs
*
* <pre>
...
#define XPLMI_PMC_GIC_IRQ_GICP7		(7U) /**< GICP7 Interrupt */
 ...
 */
#define XPLMI_GICP7_SRC3	(3U) /**< SBI Interrupt */

#define XPLMI_SBI_GICP_INDEX	(XPLMI_PMC_GIC_IRQ_GICP7) /**< SBI GICP index */
#define XPLMI_SBI_GICPX_INDEX	(XPLMI_GICP7_SRC3) /**< SBI GICPX index */
...
/******************************************************************************/
/**
 * @brief This macro calls the registered address validation handler (XPm_IsMemAddressValid)
