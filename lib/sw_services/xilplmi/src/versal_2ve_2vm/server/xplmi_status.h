...
/**
*
* @file versal_2ve_2vm/xplmi_status.h
*
* This is the header file which contains status codes for the PLM, PLMI
* and loader in versal_2ve_2vm platform.
*
* <pre>
...
typedef enum {
	...
	XLOADER_MEASURE_ROM_FAILURE,		/**< 0x3AB - Error in ROM hash extension measurement */
	XLOADER_MEASURE_PLM_FAILURE,		/**< 0x3AC - Error in PLM hash extension measurement */
	...
	XLOADER_ERR_RESERVED_63E,		/**< 0x63E - XLOADER_ERR_RESERVED_63E */
...
*/
	...
	XLOADER_ERR_RESERVED_651,		/**< 0x651 - XLOADER_ERR_RESERVED_651 */
	...
	XLOADER_ERR_AUTH_JTAG_INVALID_PARAM, /**< 0x65B Invalid parameter for JTAG authentication */
	XLOADER_ERR_AUTH_JTAG_INVALID_IDWORD, /**< 0x65C Invalid IDWORD value for JTAG authentication */
	XLOADER_ERR_PRTN_REVOKED, /**< 0x65D - Partition is revoked */
