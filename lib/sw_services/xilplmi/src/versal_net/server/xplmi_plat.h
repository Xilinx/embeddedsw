...
*       abh  11/21/2025 Fixed MISRAC Violations
*
* </pre>
*
* @note
...
#define XPLMI_ROM_KAT_MASK		(XPLMI_SECURE_SHA3_KAT_MASK | XPLMI_SECURE_RSA_KAT_MASK |\
					...
					XPLMI_SECURE_SHA384_KAT_MASK)  /**< ROM KAT mask */
...
#define XPLMI_KAT_MASK			(XPLMI_ROM_KAT_MASK | XPLMI_SECURE_RSA_PRIVATE_DEC_KAT_MASK |\
					...
					XPLMI_SECURE_ECC_DEVAK_PWCT_KAT_MASK | XPLMI_SECURE_SHA3_1_KAT_MASK) /**< KAT mask */
