...
#define XPLMI_RTCFG_SECURE_HNIC_CPM5N_PCIDE_KAT_ADDR			(XPLMI_RTCFG_BASEADDR + 0x294U)
#define XPLMI_RTCFG_SECURE_PKI_KAT_ADDR_0				(XPLMI_RTCFG_BASEADDR + 0x298U)
#define XPLMI_RTCFG_SECURE_PKI_KAT_ADDR_1				(XPLMI_RTCFG_BASEADDR + 0x29CU)
#define XPLMI_RTCFG_SECURE_PKI_KAT_ADDR_2				(XPLMI_RTCFG_BASEADDR + 0x2A0U)
