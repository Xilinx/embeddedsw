...
#define XPLMI_PROC_LOCATION_ADDRESS			(0xEBC26000U)
#define XPLMI_PROC_LOCATION_LENGTH			(0x2000U)

/* PSM sequence related constants definitions */
#define XPLMI_PROC_PSM_SEND_API_ID		(0x8U)
#define XPLMI_PROC_PSM_SEND_PROC_ID		(0xAAU) /* Preserved proc ID for PSM send sequence routine */
