...
#define XPLMI_SHA2_256_KAT_MASK                                  	(0x00800000U) /**< SHA2 256 KAT mask */
#define XPLMI_SHAKE_256_KAT_MASK                                 	(0x01000000U) /**< SHAKE KAT mask */
...
#define XPLMI_SECURE_ECC_PWCT_KAT_MASK					(0x00100000U) /**< PWCT KAT mask */
#define XPLMI_SECURE_ECC_DEVIK_PWCT_KAT_MASK				(0x00C00000U) /**< DEVIK PWCT KAT mask */
#define XPLMI_SECURE_ECC_DEVAK_PWCT_KAT_MASK				(0x01000000U) /**< DEVAK PWCT KAT mask */
...
#define XPLMI_ROM_KAT_MASK		(XPLMI_SECURE_SHA3_KAT_MASK | XPLMI_SECURE_RSA_KAT_MASK |\
					...
					XPLMI_SECURE_SHA384_KAT_MASK | XPLMI_SHA2_256_KAT_MASK | \
					XPLMI_SHAKE_256_KAT_MASK | XPLMI_LMS_SHA2_256_KAT_MASK | \
...
#define XPLMI_KAT_MASK			(XPLMI_ROM_KAT_MASK | XPLMI_SECURE_RSA_PRIVATE_DEC_KAT_MASK |\
					...
					XPLMI_SECURE_ECC_DEVAK_PWCT_KAT_MASK | XPLMI_SECURE_FIPS_STATE_MASK) /**< KAT mask */
