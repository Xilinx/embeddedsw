...
#define CRL_ASU_MB_RST_MODE_ADDR		(PSX_CRL_BASEADDR + 0x3C4U)
...
#define ASU_MB_SOFT_RST_ADDR			(ASU_GLOBAL_BASEADDR + 0x10054U)
#define ASU_MB_SOFT_RST_ASSER_MASK		(0x1U)
#define ASU_MB_SOFT_RST_DEASSERT_MASK	(0x0U)
