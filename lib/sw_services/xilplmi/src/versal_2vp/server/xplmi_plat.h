...
/**
*
* @file versal_2vp/server/xplmi_plat.h
*
...
#define XPLMI_PLM_BANNER		"AMD Versal 2vp Platform Loader and Manager \n\r"
						/**< PLM banner */
...
#define XPLMI_ROM_KAT_MASK		(XPLMI_SECURE_SHA3_KAT_MASK | XPLMI_SECURE_RSA_KAT_MASK | \
					 ...
					 XPLMI_SECURE_AES_DEC_KAT_MASK | \
					 XPLMI_SECURE_AES_CMKAT_MASK) /**< ROM KAT mask */
#define XPLMI_KAT_MASK			(XPLMI_ROM_KAT_MASK | XPLMI_SECURE_AES_ENC_KAT_MASK | \
					 XPLMI_SECURE_RSA_PRIVATE_DEC_KAT_MASK | \
					 XPLMI_SECURE_ECC_SIGN_GEN_SHA3_384_KAT_MASK | \
					 XPLMI_SECURE_ECC_PWCT_KAT_MASK) /**< KAT mask */
...
/**************************************************************************************************/
/**
 * @brief	This function returns Ipi Mask of the IPI channel that requested PLM Update.
 *
 * @return
 * 		- XST_SUCCESS always.
 *
...
{
	/* Not Applicable for Versal_2vp, so returning 0 */
	return XST_SUCCESS;
}
