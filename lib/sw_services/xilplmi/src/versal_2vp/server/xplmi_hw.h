...
/**
*
* @file versal_2vp/server/xplmi_hw.h
*
* This is the header file which contains definitions for the versal_2vp hardware registers.
*
* <pre>
 ...
 *
 * @return
 * 		- 32-bit value from 64-bit register.
 *
 **************************************************************************************************/
 ...
 *
 * @return
 * 		- 8-bit value from 64-bit register.
 *
 **************************************************************************************************/
...
{
	XPlmi_Out32(PMC_GLOBAL_PPU_1_RST_MODE, XPlmi_In32(PMC_GLOBAL_PPU_1_RST_MODE) &
...
#define PMC_TAP_IDCODE_SIREV_DVCD_MASK			(PMC_TAP_IDCODE_SI_REV_MASK | \
							 PMC_TAP_IDCODE_SBFMLY_MASK | \
							 PMC_TAP_IDCODE_DEV_MASK)
...
#define XLOADER_PMC_TAP_INST_MASK_0_OFFSET		(0xF11B0000U) /**< Instruction Mask 0
									   register address */
#define PMC_TAP_INST_MASK_0_JCONFIG_MASK		(0x20U) /**< Mask for enable JCONFIG bit*/
#define PMC_TAP_INST_MASK_0_JCONFIG_ENABLE		(0x0U) /**< Value to be written in JCONFIG
								    Register*/
...
#define XPLMI_CMD_LEN_TEMPBUF				(0x10U) /**< This buffer is used to store
								     commands which extend across
								     32K boundaries */

/* Loader chunk memory */
#define XPLMI_PMCRAM_CHUNK_MEMORY			(XPLMI_PMCRAM_BASEADDR + \
							 (XPLMI_CMD_LEN_TEMPBUF * 4U))
#define XPLMI_PMCRAM_CHUNK_MEMORY_1			(XPLMI_PMCRAM_BASEADDR + 0x8100U + \
							 (XPLMI_CMD_LEN_TEMPBUF * 4U))

/* Boot copy optimization buffer */
#define XPLMI_COPY_OPTIMIZATION_QSPI_FLASHREADID_BUFFER		(XPLMI_PMCRAM_BASEADDR + 0x10200U)
										/* 8B */
#define XPLMI_COPY_OPTIMIZATION_QSPI_SEND_BANK_READ_BUFFER	(XPLMI_PMCRAM_BASEADDR + 0x10208U)
										/* 12B */
#define XPLMI_COPY_OPTIMIZATION_QSPI_WRITE_BUFFER		(XPLMI_PMCRAM_BASEADDR + 0x10214U)
										/* 12B */
#define XPLMI_COPY_OPTIMIZATION_QSPIBUSWIDTH_BUFFER		(XPLMI_PMCRAM_BASEADDR + 0x10220U)
										/* 20B */
#define XPLMI_COPY_OPTIMIZATION_OSPI_FLASHREADID_BUFFER		(XPLMI_PMCRAM_BASEADDR + 0x10234U)
										/* 8B */
...
#define XPLMI_PMC_ALIAS_MAX_ADDR			(XPLMI_PMC_ALIAS3_BASEADDR + \
							 XPLMI_PMC_LOCAL_ADDR_LEN)
