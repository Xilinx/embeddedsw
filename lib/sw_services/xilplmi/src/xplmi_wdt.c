...
#define XPLMI_PMC_MIO_NUM		(52U)

#define XPLMI_NODE_TYPE_SHIFT		(14U)
#define XPLMI_NODE_TYPE_MASK_BITS	(0x3FU)
#define XPLMI_NODE_INDEX_MASK_BITS	(0x3FFFU)
#define XPLMI_NODE_TYPE_MASK		((u32)NODE_TYPE_MASK_BITS \
					 << NODE_TYPE_SHIFT)
#define XPLMI_PM_STMIC_LMIO		(0x14104000U)
#define XPLMI_PM_STMIC_PMIO		(0x14108000U)
