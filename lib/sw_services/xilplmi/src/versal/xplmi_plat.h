...
#define XPLMI_SECURE_ENC_KAT_MASK						(0x00000400U)
#define XPLMI_RSA_PRIVATE_DEC_KAT_MASK	 				(0x00000800U)
#define XPLMI_ECC_SIGN_GEN_SHA384_KAT_MASK 				(0x00001000U)
...
#define XPLMI_KAT_MASK			(XPLMI_ROM_KAT_MASK | XPLMI_SECURE_ENC_KAT_MASK | XPLMI_RSA_PRIVATE_DEC_KAT_MASK | \
									XPLMI_ECC_SIGN_GEN_SHA384_KAT_MASK)
