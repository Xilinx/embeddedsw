...
typedef enum {
	...
	XPM_NODEIDX_CLOCK_CPLL_PRE_SRC,	/* 0X1 */
	XPM_NODEIDX_CLOCK_CPLL_POST_SRC,	/* 0X2 */
	XPM_NODEIDX_CLOCK_CPLL_OUT,	/* 0X3 */
	XPM_NODEIDX_CLOCK_CPLL_CLK,	/* 0X4 */
	XPM_NODEIDX_CLOCK_NOCPLL_PRE_SRC,	/* 0X5 */
	XPM_NODEIDX_CLOCK_NOCPLL_POST_SRC,	/* 0X6 */
	XPM_NODEIDX_CLOCK_NOCPLL_OUT,	/* 0X7 */
	XPM_NODEIDX_CLOCK_NOCPLL_CLK,	/* 0X8 */
	XPM_NODEIDX_CLOCK_PMCPLL_PRE_SRC,	/* 0X9 */
	XPM_NODEIDX_CLOCK_PMCPLL_POST_SRC,	/* 0XA */
	XPM_NODEIDX_CLOCK_PMCPLL_OUT,	/* 0XB */
	XPM_NODEIDX_CLOCK_PMCPLL_CLK,	/* 0XC */
	XPM_NODEIDX_CLOCK_APLL1_PRE_SRC,	/* 0XD */
	XPM_NODEIDX_CLOCK_APLL1_POST_SRC,	/* 0XE */
	XPM_NODEIDX_CLOCK_APLL1_OUT,	/* 0XF */
	XPM_NODEIDX_CLOCK_APLL1_CLK,	/* 0X10 */
	XPM_NODEIDX_CLOCK_APLL2_PRE_SRC,	/* 0X11 */
	XPM_NODEIDX_CLOCK_APLL2_POST_SRC,	/* 0X12 */
	XPM_NODEIDX_CLOCK_APLL2_OUT,	/* 0X13 */
	XPM_NODEIDX_CLOCK_APLL2_CLK,	/* 0X14 */
	XPM_NODEIDX_CLOCK_RPLL_PRE_SRC,	/* 0X15 */
	XPM_NODEIDX_CLOCK_RPLL_POST_SRC,	/* 0X16 */
	XPM_NODEIDX_CLOCK_RPLL_OUT,	/* 0X17 */
	XPM_NODEIDX_CLOCK_RPLL_CLK,	/* 0X18 */
	XPM_NODEIDX_CLOCK_FLXPLL_PRE_SRC,	/* 0X19 */
	XPM_NODEIDX_CLOCK_FLXPLL_POST_SRC,	/* 0X1A */
	XPM_NODEIDX_CLOCK_FLXPLL_OUT,	/* 0X1B */
	XPM_NODEIDX_CLOCK_FLXPLL_CLK,	/* 0X1C */
	XPM_NODEIDX_CLOCK_REF_CLK,	/* 0X1D */
	XPM_NODEIDX_CLOCK_IRO,	/* 0X1E */
	XPM_NODEIDX_CLOCK_IN_REF,	/* 0X1F */
	XPM_NODEIDX_CLOCK_OSCCLK_DIV2,	/* 0X20 */
	XPM_NODEIDX_CLOCK_PL_ALT_REF_CLK,	/* 0X21 */
	XPM_NODEIDX_CLOCK_CPM5N_DBG_REF,	/* 0X22 */
	XPM_NODEIDX_CLOCK_CPM5N_AUX1_REF,	/* 0X23 */
	XPM_NODEIDX_CLOCK_CPM5N_TOPSW_REF,	/* 0X24 */
	XPM_NODEIDX_CLOCK_CPM5N_AUX0_REF,	/* 0X25 */
	XPM_NODEIDX_CLOCK_CPM5N_DMA_ALT,	/* 0X26 */
	XPM_NODEIDX_CLOCK_CPM5N_AUX2_REF,	/* 0X27 */
	XPM_NODEIDX_CLOCK_CPM5N_CORE_REF,	/* 0X28 */
	XPM_NODEIDX_CLOCK_PMC_PL2_REF,	/* 0X29 */
	XPM_NODEIDX_CLOCK_DFT_OSC_REF,	/* 0X2A */
	XPM_NODEIDX_CLOCK_PMC_RCLK,	/* 0X2B */
	XPM_NODEIDX_CLOCK_OSPI_REF,	/* 0X2C */
	XPM_NODEIDX_CLOCK_USB_SUSPEND,	/* 0X2D */
	XPM_NODEIDX_CLOCK_QSPI_REF,	/* 0X2E */
	XPM_NODEIDX_CLOCK_PMC_PL3_REF,	/* 0X2F */
	XPM_NODEIDX_CLOCK_SD_DLL_REF,	/* 0X30 */
	XPM_NODEIDX_CLOCK_NPLL_TO_XPD,	/* 0X31 */
	XPM_NODEIDX_CLOCK_HSM0_REF,	/* 0X32 */
	XPM_NODEIDX_CLOCK_HSM1_REF,	/* 0X33 */
	XPM_NODEIDX_CLOCK_PMC_PL0_REF,	/* 0X34 */
	XPM_NODEIDX_CLOCK_PMC_LSBUS_REF,	/* 0X35 */
	XPM_NODEIDX_CLOCK_EFUSE_REF,	/* 0X36 */
	XPM_NODEIDX_CLOCK_TEST_PATTERN_REF,	/* 0X37 */
	XPM_NODEIDX_CLOCK_SDIO0_REF,	/* 0X38 */
	XPM_NODEIDX_CLOCK_PMC_PL1_REF,	/* 0X39 */
	XPM_NODEIDX_CLOCK_SYSMON_REF,	/* 0X3A */
	XPM_NODEIDX_CLOCK_CFU_REF,	/* 0X3B */
	XPM_NODEIDX_CLOCK_SWITCH_TIMEOUT,	/* 0X3C */
	XPM_NODEIDX_CLOCK_SPARE_REF,	/* 0X3D */
	XPM_NODEIDX_CLOCK_NPI_REF,	/* 0X3E */
	XPM_NODEIDX_CLOCK_PPLL_TO_XPD,	/* 0X3F */
	XPM_NODEIDX_CLOCK_I2C_REF,	/* 0X40 */
	XPM_NODEIDX_CLOCK_IRO_SUSPEND_REF,	/* 0X41 */
	XPM_NODEIDX_CLOCK_SDIO1_REF,	/* 0X42 */
	XPM_NODEIDX_CLOCK_FPD_RCLK,	/* 0X43 */
	XPM_NODEIDX_CLOCK_DBG_TRACE,	/* 0X44 */
	XPM_NODEIDX_CLOCK_FPD_WWDT_PLL,	/* 0X45 */
	XPM_NODEIDX_CLOCK_FPX_TOP_SWITCH,	/* 0X46 */
	XPM_NODEIDX_CLOCK_FPX_LSBUS,	/* 0X47 */
	XPM_NODEIDX_CLOCK_PERIPH,	/* 0X48 */
	XPM_NODEIDX_CLOCK_DBG_FPX,	/* 0X49 */
	XPM_NODEIDX_CLOCK_ACPU0,	/* 0X4A */
	XPM_NODEIDX_CLOCK_ACPU3,	/* 0X4B */
	XPM_NODEIDX_CLOCK_ACPU2,	/* 0X4C */
	XPM_NODEIDX_CLOCK_ACPU1,	/* 0X4D */
	XPM_NODEIDX_CLOCK_FPX_PKI_DIV,	/* 0X4E */
	XPM_NODEIDX_CLOCK_SPI0_REF,	/* 0X4F */
	XPM_NODEIDX_CLOCK_I3C0_REF,	/* 0X50 */
	XPM_NODEIDX_CLOCK_UART0_REF,	/* 0X51 */
	XPM_NODEIDX_CLOCK_LPX_LSBUS,	/* 0X52 */
	XPM_NODEIDX_CLOCK_CAN0_REF_2X,	/* 0X53 */
	XPM_NODEIDX_CLOCK_I3C1_REF,	/* 0X54 */
	XPM_NODEIDX_CLOCK_DBG_TSTMP,	/* 0X55 */
	XPM_NODEIDX_CLOCK_IOU_SWITCH,	/* 0X56 */
	XPM_NODEIDX_CLOCK_USB0_BUS_REF,	/* 0X57 */
	XPM_NODEIDX_CLOCK_LPD_RCLK,	/* 0X58 */
	XPM_NODEIDX_CLOCK_SPI1_REF,	/* 0X59 */
	XPM_NODEIDX_CLOCK_GEM1_REF,	/* 0X5A */
	XPM_NODEIDX_CLOCK_GEM1_REF_TX,	/* 0X5B */
	XPM_NODEIDX_CLOCK_GEM1_REF_RX,	/* 0X5C */
	XPM_NODEIDX_CLOCK_RPU,	/* 0X5D */
	XPM_NODEIDX_CLOCK_RPU_OCM,	/* 0X5E */
	XPM_NODEIDX_CLOCK_RPU_XRAM,	/* 0X5F */
	XPM_NODEIDX_CLOCK_RPU_CLUSTERB,	/* 0X60 */
	XPM_NODEIDX_CLOCK_RPU_CLUSTERA,	/* 0X61 */
	XPM_NODEIDX_CLOCK_GEM0_REF,	/* 0X62 */
	XPM_NODEIDX_CLOCK_GEM0_REF_TX,	/* 0X63 */
	XPM_NODEIDX_CLOCK_GEM0_REF_RX,	/* 0X64 */
	XPM_NODEIDX_CLOCK_PSM,	/* 0X65 */
	XPM_NODEIDX_CLOCK_CPM_TOPSW,	/* 0X66 */
	XPM_NODEIDX_CLOCK_TIMESTAMP_REF,	/* 0X67 */
	XPM_NODEIDX_CLOCK_GEM_TSU_REF,	/* 0X68 */
	XPM_NODEIDX_CLOCK_CAN1_REF_2X,	/* 0X69 */
	XPM_NODEIDX_CLOCK_RPLL_TO_XPD,	/* 0X6A */
	XPM_NODEIDX_CLOCK_LPD_WWDT_PLL,	/* 0X6B */
	XPM_NODEIDX_CLOCK_USB1_BUS_REF,	/* 0X6C */
	XPM_NODEIDX_CLOCK_LPX_TOP_SWITCH,	/* 0X6D */
	XPM_NODEIDX_CLOCK_LPX_TOP_SWITCH_ADMA,	/* 0X6E */
	XPM_NODEIDX_CLOCK_DBG_LPX,	/* 0X6F */
	XPM_NODEIDX_CLOCK_UART1_REF,	/* 0X70 */
	XPM_NODEIDX_CLOCK_CPLL,	/* 0X71 */
	XPM_NODEIDX_CLOCK_NOCPLL,	/* 0X72 */
	XPM_NODEIDX_CLOCK_PMCPLL,	/* 0X73 */
	XPM_NODEIDX_CLOCK_APLL1,	/* 0X74 */
	XPM_NODEIDX_CLOCK_APLL2,	/* 0X75 */
	XPM_NODEIDX_CLOCK_RPLL,	/* 0X76 */
	XPM_NODEIDX_CLOCK_FLXPLL,	/* 0X77 */
