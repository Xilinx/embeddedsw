                ...
                u32 TagOptional, u32 *TagDataAddr)
{
	...
	u64 BisrDataDestAddr = BaseAddr | (u64)DDRMC5_NPI_CACHE_DATA_MAIN_REGISTER_OFFSET;
                ...
                u32 TagOptional, u32 *TagDataAddr)
{
	XStatus Status = XST_FAILURE;
	u32 BaseAddr = NPI_FIXED_BASEADDR | (TagOptional << NPI_EFUSE_ENDPOINT_SHIFT);
	u64 BisrDataDestAddr = BaseAddr | (u64)DDRMC5_NPI_CACHE_DATA_CRYPTO_REGISTER_OFFSET;
