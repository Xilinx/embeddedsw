...
elseif("${CMAKE_MACHINE}" STREQUAL "Versal")
  ...
  if("${CPM6_SUPPORTED}" STREQUAL "ON")
    option(XILPM_enable_gpio_proc_handler "true: Include gpio proc handler feature support, false: Exclude gpio proc handler feature support" ON)
  else()
