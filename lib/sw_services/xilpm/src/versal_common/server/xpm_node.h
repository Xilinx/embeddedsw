...
typedef enum {
	...
	XPM_NODEIDX_CLK_SEIO_UART0_REF = 0xE6,
	XPM_NODEIDX_CLK_SEIO_UART1_REF = 0xE7,
	XPM_NODEIDX_CLK_SEIO_UART2_REF = 0xE8,
	XPM_NODEIDX_CLK_SEIO_SPI0_REF = 0xE9,
	XPM_NODEIDX_CLK_SEIO_SPI1_REF = 0xEA,
	XPM_NODEIDX_CLK_SEIO_SPI2_REF = 0xEB,
	XPM_NODEIDX_CLK_SEIO_SPI3_REF = 0xEC,
	XPM_NODEIDX_CLK_MAX = 0xED
} XPm_ClockNodeIdx;
...
typedef enum {
	...
	XPM_NODEIDX_RST_SEIO_UART_0 = 0x125,
	XPM_NODEIDX_RST_SEIO_UART_1 = 0x126,
	XPM_NODEIDX_RST_SEIO_UART_2 = 0x127,
	XPM_NODEIDX_RST_SEIO_SPI_0 = 0x128,
	XPM_NODEIDX_RST_SEIO_SPI_1 = 0x129,
	XPM_NODEIDX_RST_SEIO_SPI_2 = 0x12A,
	XPM_NODEIDX_RST_SEIO_SPI_3 = 0x12B,
	XPM_NODEIDX_RST_GPIO_SEIO = 0x12C,
...
typedef enum {
	...
	XPM_NODEIDX_DEV_SEIO_UART_0 = 0x13D,
	XPM_NODEIDX_DEV_SEIO_UART_1 = 0x13E,
	XPM_NODEIDX_DEV_SEIO_UART_2 = 0x13F,
	XPM_NODEIDX_DEV_SEIO_SPI_0 = 0x140,
	XPM_NODEIDX_DEV_SEIO_SPI_1 = 0x141,
