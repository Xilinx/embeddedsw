...
#define PM_POWER_VCCINT_VCU			(0x4328052U)
#define PM_POWER_VCCINT_ISP			(0x4328053U)
#define PM_POWER_MMI				(0x4238054U)
#define PM_POWER_VCU				(0x423C055U)
#define PM_POWER_ISP				(0x4240056U)
#define PM_POWER_OCM_2_0			(0x4104057U)
#define PM_POWER_OCM_2_1			(0x4104058U)
#define PM_POWER_OCM_2_2			(0x4104059U)
#define PM_POWER_OCM_2_3			(0x410405AU)
#define PM_POWER_OCM_3_0			(0x410405BU)
#define PM_POWER_OCM_3_1			(0x410405CU)
#define PM_POWER_OCM_3_2			(0x410405DU)
#define PM_POWER_OCM_3_3			(0x410405EU)
#define PM_POWER_TCM_0_C			(0x410405FU)
#define PM_POWER_TCM_0_D			(0x4104060U)
#define PM_POWER_TCM_0_E			(0x4104061U)
#define PM_POWER_TCM_1_C			(0x4104062U)
#define PM_POWER_TCM_1_D			(0x4104063U)
#define PM_POWER_TCM_1_E			(0x4104064U)
/** @} */
...
#define PM_CLK_MMI_TOPSW			(0x82080BBU)
#define PM_CLK_I3C4_REF				(0x82080BCU)
#define PM_CLK_I3C3_REF				(0x82080BDU)
#define PM_CLK_I3C2_REF				(0x82080BEU)
#define PM_CLK_RPU_CLUSTERC			(0x82080BFU)
#define PM_CLK_RPU_CLUSTERD			(0x82080C0U)
#define PM_CLK_RPU_CLUSTERE			(0x82080C1U)
#define PM_CLK_CAN2_REF_2X			(0x82080C2U)
#define PM_CLK_LPD_TOP_SWITCH_SDMA		(0x82080C3U)
#define PM_CLK_I3C7_REF				(0x82080C4U)
#define PM_CLK_I3C6_REF				(0x82080C5U)
#define PM_CLK_ASU				(0x82080C6U)
#define PM_CLK_CAN3_REF_2X			(0x82080C7U)
#define PM_CLK_I3C5_REF				(0x82080C8U)
#define PM_CLK_DC_RCLK				(0x82080C9U)
#define PM_CLK_MMI_DBG				(0x82080CAU)
#define PM_CLK_UFS_REF				(0x82080CBU)
#define PM_CLK_RCLK_MMI				(0x82080CCU)
...
#define PM_ISO_PL_GEM_N				(0x2000004AU)
#define PM_ISO_PL_DC_N				(0x2000004BU)
#define PM_ISO_MMI_N				(0x2000004CU)
#define PM_ISO_FPD_MMI_DFX			(0x2000004DU)
#define PM_ISO_FPD_MMI				(0x2000004EU)
/** @} */
/** @endcond */
