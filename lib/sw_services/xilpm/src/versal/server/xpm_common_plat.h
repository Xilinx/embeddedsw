...
/* VC2802 */
#define PMC_TAP_IDCODE_DEV_VC2802		((u32)0x10U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VC2802	(XPM_PMC_TAP_IDCODE_SBFMLY_SV | PMC_TAP_IDCODE_DEV_VC2802)
