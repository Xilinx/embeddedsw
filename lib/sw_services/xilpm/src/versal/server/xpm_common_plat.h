...
/**
 * @def PMC_TAP_IDCODE_DEV_VP3202
 * @brief Tap ID Code for VP3202 device.
 *
 * @def PMC_TAP_IDCODE_DEV_SBFMLY_VP3202
 * @brief Tap ID Code with Sub-Family for VP3202 device.
 */
#define PMC_TAP_IDCODE_DEV_VP3202		((u32)0x28U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VP3202	(XPM_PMC_TAP_IDCODE_SBFMLY_P_HS | PMC_TAP_IDCODE_DEV_VP3202)
/**
 * @def PMC_TAP_IDCODE_DEV_VP3102
 * @brief Tap ID Code for VP3102 device.
 *
 * @def PMC_TAP_IDCODE_DEV_SBFMLY_VP3102
 * @brief Tap ID Code with Sub-Family for VP3102 device.
 */
#define PMC_TAP_IDCODE_DEV_VP3102		((u32)0x29U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VP3102	(XPM_PMC_TAP_IDCODE_SBFMLY_P_HS | PMC_TAP_IDCODE_DEV_VP3102)
/**
 * @def PMC_TAP_IDCODE_DEV_VP3602
 * @brief Tap ID Code for VP3602 device.
 *
 * @def PMC_TAP_IDCODE_DEV_SBFMLY_VP3602
 * @brief Tap ID Code with Sub-Family for VP3602 device.
 */
#define PMC_TAP_IDCODE_DEV_VP3602		((u32)0x34U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VP3602	(XPM_PMC_TAP_IDCODE_SBFMLY_P_HS | PMC_TAP_IDCODE_DEV_VP3602)
/**
 * @def PMC_TAP_IDCODE_DEV_VP3402
 * @brief Tap ID Code for VP3402 device.
 *
 * @def PMC_TAP_IDCODE_DEV_SBFMLY_VP3402
 * @brief Tap ID Code with Sub-Family for VP3402 device.
 */
#define PMC_TAP_IDCODE_DEV_VP3402		((u32)0x35U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VP3402	(XPM_PMC_TAP_IDCODE_SBFMLY_P_HS | PMC_TAP_IDCODE_DEV_VP3402)
/**
 * @def PMC_TAP_IDCODE_DEV_VP3502
 * @brief Tap ID Code for VP3502 device.
 *
 * @def PMC_TAP_IDCODE_DEV_SBFMLY_VP3502
 * @brief Tap ID Code with Sub-Family for VP3502 device.
 */
#define PMC_TAP_IDCODE_DEV_VP3502		((u32)0x36U << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VP3502	(XPM_PMC_TAP_IDCODE_SBFMLY_P_HS | PMC_TAP_IDCODE_DEV_VP3502)
/* VR16XX_PARENT */
