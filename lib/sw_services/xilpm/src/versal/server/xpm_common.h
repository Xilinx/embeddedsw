...
/* VC1502 */
#define PMC_TAP_IDCODE_DEV_VC1502		((u32)0x1BU << XPM_PMC_TAP_IDCODE_DEV_SHIFT)
#define PMC_TAP_IDCODE_DEV_SBFMLY_VC1502	(XPM_PMC_TAP_IDCODE_SBFMLY_S | PMC_TAP_IDCODE_DEV_VC1502)
