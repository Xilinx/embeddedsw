...
#define PCIE_ATTRIB_0_TDVSEC_NXT_PTR				( PCIEA_ATTRIB_0_BASEADDR + 0x00000A34 )
...
#define XMPU_R00_START_LO_OFFSET				(0x100)
#define XMPU_R00_START_HI_OFFSET				(0x104)
#define XMPU_R00_END_LO_OFFSET					(0x108)
#define XMPU_R00_END_HI_OFFSET					(0x10C)
#define XMPU_R00_CONFIG_OFFSET					(0x114)
