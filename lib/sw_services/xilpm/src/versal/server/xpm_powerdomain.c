...
static XStatus SysmonVoltageCheck(const XPm_Rail *Rail, u32 RailVoltage)
{
	...
	const u32 RailVoltageTable[8][2] = {
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_PMC)] = {VCCINT_PMC_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCAUX_PMC)] = {VCCAUX_PMC_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_PSLP)] = {VCCINT_PSLP_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_PSFP)] = {VCCINT_PSFP_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_SOC)] = {VCCINT_SOC_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_RAM)] = {VCCINT_RAM_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCAUX)] = {VCCAUX_VOLTAGE_MIN, EFUSE_BLOWN},
		[RAILIDX(XPM_NODEIDX_POWER_VCCINT_PL)] = {VCCINT_PL_VOLTAGE_MIN, EFUSE_BLOWN},
	};
