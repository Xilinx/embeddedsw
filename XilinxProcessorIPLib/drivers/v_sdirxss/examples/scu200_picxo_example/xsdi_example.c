...
int main(void)
{
	...
	Gpio_Rx_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_FMC_INIT_DONE_GPIO_BASEADDR);
#else
	Gpio_Rx_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_FMC_INIT_DONE_GPIO_BASEADDR);
#endif
	...
	Gpio_Tx_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_SDI_TX_RESET_GPIO_BASEADDR);
#else
	Gpio_Tx_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_SDI_TX_RESET_GPIO_BASEADDR);
#endif
	...
	Gpio_AxisFifo_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_GPIO_REGISTER_AXIS_FIFO_GPIO_BASEADDR);
#else
	Gpio_AxisFifo_resetn_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_GPIO_REGISTER_AXIS_FIFO_GPIO_BASEADDR);
#endif
	...
	Gpio_si570_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_GPIO_REGISTER_SIXXXX_LOL1_GPIO_BASEADDR);
#else
	Gpio_si570_ConfigPtr =
		XGpio_LookupConfig(XPAR_MICROBLAZE_SS_0_GPIO_REGISTER_SIXXXX_LOL1_GPIO_BASEADDR);
#endif
