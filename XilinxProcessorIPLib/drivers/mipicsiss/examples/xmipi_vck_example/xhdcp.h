...
/*< Size in bytes of ReceiverID for HDCP 2.2 or KSV for HDCP 1.4 */
#define XHDCP_DEVICE_ID_SIZE               5
/*< Maximum number of HDCP downstream interfaces allowed */
#define XHDCP_MAX_DOWNSTREAM_INTERFACES    32
/*< Maximum repeater topology device count for HDCP 1.4 */
#define XHDCP_MAX_DEVICE_CNT_HDCP14        127
/*< Maximum repeater topology depth for HDCP 1.4 */
#define XHDCP_MAX_DEPTH_HDCP14             7
/*< Maximum repeater topology device count for HDCP 2.2 */
#define XHDCP_MAX_DEVICE_CNT_HDCP22        31
/*< Maximum repeater topology depth for HDCP 2.2 */
#define XHDCP_MAX_DEPTH_HDCP22             4
