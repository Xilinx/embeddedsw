...
#define GPIO_IP_RESET	 	XPAR_XGPIO_1_BASEADDR
#endif
...
/*****************************************************************************/
/**
* This function resets OS12D40(Omnivision) camera sensor.
*
* @return	None.
*
* @note		None.
...
int SetupCameraSensor(void) {
	...
	switch (Pipeline_Cfg.VideoMode) {
		...
		case XVIDC_VM_1280x720_60_P:
			MaxIndex = length_OS12D40_config_1080p_60fps_regs;
			sensor_cfg = OS12D40_config_1080p_60fps_regs;
			break;
		...
		case XVIDC_VM_3840x2160_30_P:
			MaxIndex = length_OS12D40_config_4K_60fps_regs;
			sensor_cfg = OS12D40_config_4K_60fps_regs;
			break;
