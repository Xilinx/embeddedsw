...
#ifndef SDT
#define XGPIO_TREADY_DEVICE_ID	XPAR_GPIO_0_DEVICE_ID
#else
...
void XMipi_DisplayMainMenu(void)
{
	...
	do {
			...
			Response = XUartLite_RecvByte(XPAR_XUARTLITE_0_BASEADDR);

			XUartLite_SendByte(XPAR_XUARTLITE_0_BASEADDR, Response);
