...
#define HDMI_TXSS_INTR_ID	XPAR_FABRIC_HDMI_DISPLAY_PATH_V_HDMI_TX_SS_0_IRQ_INTR
#define HDMI_TX_SS_INTR_ID 	HDMI_TXSS_INTR_ID

#define VPHY_DEV_ID	XPAR_VPHY_0_DEVICE_ID
#define VPHY_INTRID	XPAR_FABRIC_HDMI_DISPLAY_PATH_VID_PHY_CONTROLLER_0_IRQ_INTR
