...
//#if defined (XPS_BOARD_ZCU102)
//	{RX_TI_FRL_12G_R1, 0x0D, 0xE3}, //e3}, //63
//#else //vcu118
//	{RX_TI_FRL_12G_R1, 0x0D, 0xE3}, //63
//#endif
//	{RX_TI_FRL_12G_R1, 0x12, 0x02}, //63
//#if defined (XPS_BOARD_ZCU102)
//	{RX_TI_FRL_12G_R1, 0x13, 0x01}, //value
//#else //vcu118
//	{RX_TI_FRL_12G_R1, 0x13, 0x01}, //value
//#endif
//	{RX_TI_FRL_12G_R1, 0x14, 0x02},
//	{RX_TI_FRL_12G_R1, 0x15, 0x01}, // value
//	{RX_TI_FRL_12G_R1, 0x16, 0x70},
//	{RX_TI_FRL_12G_R1, 0x17, 0x01}, //value
//#if defined (XPS_BOARD_ZCU102)
//	{RX_TI_FRL_12G_R1, 0x18, 0x02},
//#else
//	{RX_TI_FRL_12G_R1, 0x18, 0x06},
//#endif
//	{RX_TI_FRL_12G_R1, 0x19, 0x01}, //value
//	{RX_TI_FRL_12G_R1, 0x20, 0x00},
//	{RX_TI_FRL_12G_R1, 0x31, 0x06}, // 12gx4
//	{RX_TI_FRL_12G_R1, 0x11, 0x0F},

// Note for Shreesh
// there are two registers that we can tweak per lane
// you will have to tweak the registers to find out
// which one affects which lane
// reg 12, 13 - link 3 0x01/0x00, 0x00 - 46.15  0x01 and 0x10 only 18
// reg 14, 15 - link 0 0x01, 0x00 - 44.62
// reg 16, 17 - link 1 0x00, 0x01 - 43.08
// reg 18, 19 - link 2 0x00, 0x00 - 47.69
// So there are 4 "even" regs and 4 "odd" regs
// refer the datasheet and see if tweaking these improves or worse


	//working well with club3d
...
//	xil_printf ("Value of ByteCount is %d \n\r", ByteCount);
	if (ByteCount != 2) {
		return XST_FAILURE;
	}
...
//		xil_printf("Value of address: 0x%x, Value written: 0x%x \n\r", TiRegisterFields[i].Address, TiRegisterFields[i].Values);
...
//	xil_printf("Device ID is %d", DeviceId);
...
//	xil_printf("Device type is %d \n\r", DeviceType);
//	xil_printf("TI Register Device type is %d \n\r", TiRegisterFields[i].DeviceType);
	...
	while (DeviceType == TiRegisterFields[i].DeviceType) {
		...
		Data = TI_TMDS1204_GetRegister(IicPtr, I2CSlaveAddress, TiRegisterFields[i].Address);

//		xil_printf("Value of address: 0x%x, Value written: 0x%x \n\r", TiRegisterFields[i].Address, TiRegisterFields[i].Values);
//		xil_printf("Data value: 0x%x\n\r", Data);
