...
#define DDR_BASEADDR XPAR_LPDDRMC_0_BASEADDRESS
...
u32 frame_array[5] = {BUFFER_BASEADDR0, BUFFER_BASEADDR1, BUFFER_BASEADDR2, BUFFER_BASEADDR3, BUFFER_BASEADDR4};
u32 rd_ptr = 4 ;
u32 wr_ptr = 0 ;
...
void Reset_IP_Pipe(void)
{
	...
	Xil_Out32(GPIO_IP_RESET, 0xFFFFFFFF);
#else
	Xil_Out32(XPAR_AXI_GPIO_1_BASEADDR, 0xFFFFFFFF);
	Xil_Out32(XPAR_AXI_GPIO_1_BASEADDR, 0x00000000);
	Xil_Out32(XPAR_AXI_GPIO_1_BASEADDR, 0xFFFFFFFF);
#endif
}
...
/*****************************************************************************/
/**
* This function resets IMX219 camera sensor.
*
* @return	None.
*
* @note		None.
...
void CamReset(void)
{
	...
	Xil_Out32(GPIO_SENSOR, 0x07);
#else
	Xil_Out32(XPAR_XGPIO_3_BASEADDR, 0x1);
	Xil_Out32(XPAR_XGPIO_3_BASEADDR, 0x0);
	Xil_Out32(XPAR_XGPIO_3_BASEADDR, 0x1);
#endif
}
...
int SetupCameraSensor(void) {
	...
	switch (Pipeline_Cfg.VideoMode) {
		...
		case XVIDC_VM_1280x720_60_P:
			MaxIndex = length_IMX219_config_1080p_60fps_regs;
			sensor_cfg = IMX219_config_1080p_60fps_regs;
			break;
...
int start_csi_cap_pipe(XVidC_VideoMode VideoMode)
{
	...
	stride = CalcStride(Cfmt ,
	 ...
	 Xil_Out32(XPAR_XGPIO_1_BASEADDR,  0xffffffff);
