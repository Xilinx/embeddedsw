...
int config_hdmi()
{
...
#elif (__microblaze__)  || defined (__riscv)
	...
	Status = Vfmc_HdmiInit(&Vfmc[0], XPAR_HDMI_HIER_0_AXI_GPIO_0_DEVICE_ID,
						&Iic, VFMC_HPC0);
#else
	Status = Vfmc_HdmiInit(&Vfmc[0], XPAR_HDMI_TXSS_HIER_0_VFMC_CTLR_SS_0_VFMC_GPIO_BASEADDR,
                 &Iic, VFMC_HPC0);
#endif
...
#endif
//this design doesn't have axi4s remapper
#ifdef XPAR_XV_AXI4S_REMAP_NUM_INSTANCES
