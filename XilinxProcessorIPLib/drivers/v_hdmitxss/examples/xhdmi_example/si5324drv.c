 ...
 *****************************************************************************/
s32 Si5324_DoSettings_Ps(XIicPs *InstancePtr, u16 IICAddress,
 ...
 *****************************************************************************/
s32 Si5324_Reset_Ps(XIicPs *InstancePtr, u16 IICAddress) {
    s32 Status;
    u8 buf[2];
    ...
    Status = Si5324_DoSettings_Ps(InstancePtr, IICAddress, buf, 2);
 ...
 * @return   SI5324_SUCCESS for success, SI5324_ERR_IIC for IIC access failure.
 *****************************************************************************/
s32 Si5324_Init_Ps(XIicPs *InstancePtr, u16 IICAddress) {
    s32 result;

    if (SI5324_DEBUG) {
        xil_printf("Si5324: Initializing.\n");
    }
    result = Si5324_DoSettings_Ps(InstancePtr, IICAddress,
 ...
 *****************************************************************************/
s32 Si5324_SetClock_Ps(XIicPs *InstancePtr, u16 IICAddress, u8 ClkSrc,
    ...
    Status = Si5324_CalcFreqSettings(ClkInFreq, ClkOutFreq,
...
//    i += 6;
    ...
    Status = Si5324_DoSettings_Ps(InstancePtr, IICAddress,
                               buf, i / 2);
    return Status;
}
#endif
