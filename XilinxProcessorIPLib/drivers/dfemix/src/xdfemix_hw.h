...
#define XDFEMIX_MODEL_PARAM_1_NUM_AUXILIARY_WIDTH 2U
...
#define XDFEMIX_DUC_DDC_STATUS_OVERFLOW_ASSOCIATED_MODE_WIDTH 4U
...
#define XDFEMIX_MIXER_STATUS_OVERFLOW_ASSOCIATED_MODE_WIDTH 5U
