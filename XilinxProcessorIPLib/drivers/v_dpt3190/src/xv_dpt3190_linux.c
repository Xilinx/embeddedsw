...
typedef struct {
    ...
    XV_dpt3190_uio_map maps[ MAX_UIO_MAPS ];
} XV_dpt3190_uio_info;

/***************** Variable Definitions **************************************/
static XV_dpt3190_uio_info uio_info;
...
static int uio_info_read_name(XV_dpt3190_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XV_dpt3190_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XV_dpt3190_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XV_dpt3190_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XV_dpt3190_Initialize(XV_dpt3190 *InstancePtr, const char* InstanceName) {
    XV_dpt3190_uio_info *InfoPtr = &uio_info;
