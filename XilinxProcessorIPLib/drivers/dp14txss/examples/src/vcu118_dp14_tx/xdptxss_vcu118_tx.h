...
#ifndef SRC_XDPTXSS_VCU118_TX_H_
#define SRC_XDPTXSS_VCU118_TX_H_
...
volatile int tx_is_reconnected; /*This variable to keep track of the status of Tx link*/
...
#endif /* SRC_XDPTXSS_VCU118_TX_H_ */
