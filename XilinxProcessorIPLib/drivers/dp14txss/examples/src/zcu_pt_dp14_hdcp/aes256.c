...
*
*   Copyright (c) 2020-2021 Ilya O. Levin, http://www.literatecode.com
...
void aes_shiftRows(uint8_t *buf)
{
    ...
    i = buf[1]; buf[1] = buf[5]; buf[5] = buf[9];
	buf[9] = buf[13]; buf[13] = i;
    i = buf[10]; buf[10] = buf[2]; buf[2] = i;
    j = buf[3]; buf[3] = buf[15]; buf[15] = buf[11];
	buf[11] = buf[7]; buf[7] = j;
...
void aes_shiftRows_inv(uint8_t *buf)
{
    ...
    i = buf[1]; buf[1] = buf[13]; buf[13] = buf[9];
	buf[9] = buf[5]; buf[5] = i;
    i = buf[2]; buf[2] = buf[10]; buf[10] = i;
    j = buf[3]; buf[3] = buf[7]; buf[7] = buf[11];
	buf[11] = buf[15]; buf[15] = j;
