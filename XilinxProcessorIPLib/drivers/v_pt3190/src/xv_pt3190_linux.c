...
typedef struct {
    ...
    XV_pt3190_uio_map maps[ MAX_UIO_MAPS ];
} XV_pt3190_uio_info;

/***************** Variable Definitions **************************************/
static XV_pt3190_uio_info uio_info;
...
static int uio_info_read_name(XV_pt3190_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XV_pt3190_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XV_pt3190_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XV_pt3190_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XV_pt3190_Initialize(XV_pt3190 *InstancePtr, const char* InstanceName) {
    XV_pt3190_uio_info *InfoPtr = &uio_info;
