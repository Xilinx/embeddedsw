...
*               configuration.
*               - This function calls other functions which contain
*               loops that may be infinite if interrupts are not working such
*               that it may not return. If the device slave select is not
*               correct and the device is not responding on bus it will
*               read a status of 0xFF for the status register as the bus is
*               pulled up.
*
*****************************************************************************/
#ifndef SDT
