...
/*************************************************************************************************/
/**
 * @file  xtrngpsv_ptrng_df_example.c
 *
 * This example demonstrates use of instantiate, generate functionalities while
 * generating random number using PTRNG mode (with DF).
 *
 * @note
 *
 * None.
...
int main(void)
{
	...
	xil_printf("Successfully ran TRNGPSV PTRNG (DF) example\n\r");
...
/**
 * @brief
 * This function tests the functioning of the TRNG in PTRNG mode (with Derivative Function).
 *
