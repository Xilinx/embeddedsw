...
void XV_gamma_lut_Start(XV_gamma_lut *InstancePtr) {
    ...
    Data = XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_AP_CTRL) & 0x80;
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_AP_CTRL, Data | 0x01);
}
...
u32 XV_gamma_lut_IsDone(XV_gamma_lut *InstancePtr) {
    ...
    Data = XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_AP_CTRL);
    return (Data >> 1) & 0x1;
}
...
void XV_gamma_lut_EnableAutoRestart(XV_gamma_lut *InstancePtr) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_AP_CTRL, 0x80);
}
...
void XV_gamma_lut_DisableAutoRestart(XV_gamma_lut *InstancePtr) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_AP_CTRL, 0);
}
...
void XV_gamma_lut_Set_HwReg_width(XV_gamma_lut *InstancePtr, u32 Data) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_WIDTH_DATA, Data);
}
...
u32 XV_gamma_lut_Get_HwReg_width(XV_gamma_lut *InstancePtr) {
    ...
    Data = XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_WIDTH_DATA);
    return Data;
}
...
void XV_gamma_lut_Set_HwReg_height(XV_gamma_lut *InstancePtr, u32 Data) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_HEIGHT_DATA, Data);
}
...
u32 XV_gamma_lut_Get_HwReg_height(XV_gamma_lut *InstancePtr) {
    ...
    Data = XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_HEIGHT_DATA);
    return Data;
}
...
void XV_gamma_lut_Set_HwReg_video_format(XV_gamma_lut *InstancePtr, u32 Data) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_VIDEO_FORMAT_DATA, Data);
}
...
u32 XV_gamma_lut_Get_HwReg_video_format(XV_gamma_lut *InstancePtr) {
    ...
    Data = XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_HWREG_VIDEO_FORMAT_DATA);
    return Data;
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_0_BaseAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE);
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_0_HighAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_HIGH);
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_0_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_0_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_0_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_0_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + offset + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_1_BaseAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE);
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_1_HighAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_HIGH);
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_1_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_1_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_1_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_1_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + offset + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_2_BaseAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE);
}
...
u32 XV_gamma_lut_Get_HwReg_gamma_lut_2_HighAddress(XV_gamma_lut *InstancePtr) {
    ...
    return (InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_HIGH);
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_2_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_2_Words(XV_gamma_lut *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_2_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XV_gamma_lut_Read_HwReg_gamma_lut_2_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Ctrl_BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + offset + i);
    }
    return length;
}
...
void XV_gamma_lut_InterruptGlobalEnable(XV_gamma_lut *InstancePtr) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_GIE, 1);
}
...
void XV_gamma_lut_InterruptGlobalDisable(XV_gamma_lut *InstancePtr) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_GIE, 0);
}
...
void XV_gamma_lut_InterruptEnable(XV_gamma_lut *InstancePtr, u32 Mask) {
    ...
    Register =  XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_IER);
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_IER, Register | Mask);
}
...
void XV_gamma_lut_InterruptClear(XV_gamma_lut *InstancePtr, u32 Mask) {
    ...
    XV_gamma_lut_WriteReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_ISR, Mask);
}
...
u32 XV_gamma_lut_InterruptGetEnabled(XV_gamma_lut *InstancePtr) {
    ...
    return XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_IER);
}
...
u32 XV_gamma_lut_InterruptGetStatus(XV_gamma_lut *InstancePtr) {
    ...
    return XV_gamma_lut_ReadReg(InstancePtr->Ctrl_BaseAddress, XV_GAMMA_LUT_CTRL_ADDR_ISR);
}
