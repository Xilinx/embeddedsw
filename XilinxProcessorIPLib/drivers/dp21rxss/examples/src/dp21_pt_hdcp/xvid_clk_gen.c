...
// Refer to the device DS and switching characteristics and update for
// your design
...
void Gen_vid_clk(XDp *InstancePtr, u8 Stream)
{
	...
	/* The clock generated from clk_wiz is not accurate. For example in case of 148.5 MHz
	 * clock generated would be 148. Hence adding 1 MHz. This will make the TX vid_clk
