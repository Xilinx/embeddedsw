...
int ClockedExample(u16 RFdcDeviceId)
{
	...
	if(XRFdc_IsHighSpeedADC(RFdcInstPtr, Tile) == XRFDC_ENABLED) { /*ZCU208*/
		DistributionSettings.SourceTileId = XRFDC_TILE_ID0;
	} else { /*ZCU216*/
		DistributionSettings.SourceTileId = XRFDC_TILE_ID2;
	}

	DistributionSettings.SourceType = XRFDC_DAC_TILE;
	DistributionSettings.EdgeTileIds[0] = XRFDC_TILE_ID0;
	DistributionSettings.EdgeTileIds[1] = XRFDC_TILE_ID3;
	DistributionSettings.EdgeTypes[0] = XRFDC_DAC_TILE;
	DistributionSettings.EdgeTypes[1] = XRFDC_DAC_TILE;
	DistributionSettings.DistRefClkFreq = 245.76;
	DistributionSettings.DistributedClock = XRFDC_DIST_OUT_RX;
	DistributionSettings.SampleRates[1][0] = 2211.84;
	DistributionSettings.SampleRates[1][1] = 2211.84;
	DistributionSettings.SampleRates[1][2] = 2211.84;
	DistributionSettings.SampleRates[1][3] = 2211.84;
	...
	DistributionSettings.SourceTileId = XRFDC_TILE_ID2;
	DistributionSettings.SourceType = XRFDC_ADC_TILE;
	DistributionSettings.EdgeTileIds[0] = XRFDC_TILE_ID0;
	DistributionSettings.EdgeTileIds[1] = XRFDC_TILE_ID3;
	DistributionSettings.EdgeTypes[0] = XRFDC_ADC_TILE;
	DistributionSettings.EdgeTypes[1] = XRFDC_ADC_TILE;
	DistributionSettings.DistRefClkFreq = 245.76;
	DistributionSettings.DistributedClock = XRFDC_DIST_OUT_RX;
	DistributionSettings.SampleRates[0][0] = 2211.84;
	DistributionSettings.SampleRates[0][1] = 2211.84;
	DistributionSettings.SampleRates[0][2] = 2211.84;
	DistributionSettings.SampleRates[0][3] = 2211.84;
	Status = XRFdc_SetClkDistribution(RFdcInstPtr, &Distribution_Settings);
	if (Status != XRFDC_SUCCESS) {
		return XRFDC_FAILURE;
	}
